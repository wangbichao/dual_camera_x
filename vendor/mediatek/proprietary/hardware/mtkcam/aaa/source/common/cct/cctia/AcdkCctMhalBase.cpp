 ...
 * brief :
 *******************************************************************************/
#define LOG_TAG "AcdkCctMhalBase"
...
*
********************************************************************************/
AcdkCctMhalBase *AcdkCctMhalBase::createInstance(MUINT32 OpenMode)
{

    if(OpenMode == 0)
    {
        ACDK_LOGD("createInstance : AcdkCctMhalPure\n");
        return new AcdkCctMhalPure;
    }
    else
    {
        ACDK_LOGD("createInstance : AcdkCctMhalEng\n");
        return new AcdkCctMhalEng;
    }
}
