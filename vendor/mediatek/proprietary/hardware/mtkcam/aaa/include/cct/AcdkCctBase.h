...
#ifndef _ACDKCCTBASE_H_
#define _ACDKCCTBASE_H_
...
namespace NSACDK
{
         ...
         */
    typedef enum _ACDK_CCT_BYPASS_FLAG {
        ACDK_CCT_BYPASS_NONE        = 0x00,
        ACDK_CCT_BYPASS_PURE_P2     = 0x02,
        ACDK_CCT_BYPASS_SURFACEVIEW = 0x04
    } ACDK_CCT_BYPASS_FLAG;
    class AcdkCctBase
    {
    public:

               /**
                *@brief Create AcdkCctBase Object
                *@note Actually, it will create AcdkMain object
                */
        static AcdkCctBase* createInstance(ACDK_CCT_BYPASS_FLAG bypassFlags = ACDK_CCT_BYPASS_NONE);

               /**
                *@brief Destory AcdkCctBase Object
                */
        ...
        virtual MINT32 stopPreview() = 0;
                ...
                *-0 indicates success, otherwise indicates fail
                */
        virtual MINT32 startPreview_CameraDev(Func_CB prvCb, MUINT32 const mode = 0 ) = 0;
