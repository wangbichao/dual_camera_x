...
#ifndef _ACDKCCTMHALPURE_H_
#define _ACDKCCTMHALPURE_H_
...
namespace NSAcdkCctMhal
{
    ...
    typedef struct _acdkBufCtl_t {
         ...
         */
    class AcdkCctMhalPure : public AcdkCctMhalBase {
    public :

                  /**
                   *@brief AcdkCctMhalPure constructor
                   */
        AcdkCctMhalPure();

                  /**
                   *@brief AcdkCctMhalPure destructor
                   */
        ~AcdkCctMhalPure() {};

                  /**
                   *@brief Destory AcdkCctMhalPure Object
                   */
