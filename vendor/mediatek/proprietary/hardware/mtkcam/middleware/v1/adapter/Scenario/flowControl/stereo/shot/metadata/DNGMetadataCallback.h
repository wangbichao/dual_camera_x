...
/**
 * @file DNGMetadataCallback.h
 * @brief DNG metadata callback
*/

#ifndef _MTK_LEGACYPIPELINE_STEREO_SHOT_DNG_METADATA_CALLBACK_H_
#define _MTK_LEGACYPIPELINE_STEREO_SHOT_DNG_METADATA_CALLBACK_H_
...
********************************************************************************/
/**
 * @class DNGMetadataCallback
 * @brief This class is use to send shutter callback for specific stream id.
 */
class DNGMetadataCallback : public IMetaShotCallback
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Instantiation.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
// Constructor
    DNGMetadataCallback() = delete;
    DNGMetadataCallback(StreamId_T streamId, IMetadata metadata);

protected:
// Destructor
    virtual ~DNGMetadataCallback();
