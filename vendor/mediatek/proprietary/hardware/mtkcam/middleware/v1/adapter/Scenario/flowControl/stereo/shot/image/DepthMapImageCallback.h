...
/**
 * @file DepthMapImageCallback.h
 * @brief DepthMapImageCallback interface.
*/

#ifndef _MTK_LEGACYPIPELINE_STEREO_SHOT_DEPTHMAP_IMETACALLBACK_H_
#define _MTK_LEGACYPIPELINE_STEREO_SHOT_DEPTHMAP_IMETACALLBACK_H_
...
********************************************************************************/
/**
 * @class DepthMapImageCallback
 * @brief Processing depth map image callback.
 */
class DepthMapImageCallback : public IImageShotCallback
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Instantiation.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
// Constructor
    DepthMapImageCallback() = delete;
    DepthMapImageCallback(ImageCallbackParams params);

protected:
// Destructor
   virtual ~DepthMapImageCallback();
