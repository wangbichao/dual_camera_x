    ...
    {
        {
            ...
            // post-view
            stereoShotParam.mShotParam.mi4PostviewWidth          = iPreviewWidth;
            stereoShotParam.mShotParam.mi4PostviewHeight         = iPreviewHeight;
            //int iPostviewThumbFmt = MtkCameraParameters::queryImageFormat(pParamsMgr->getStr(MtkCameraParameters::KEY_POST_VIEW_FMT));
            //stereoShotParam.mShotParam.iPostviewThumbFmt = (iPostviewThumbFmt != NSCam::eImgFmt_UNKNOWN) ? iPostviewThumbFmt : NSCam::eImgFmt_NV21;
            //
            {
