...
/**
 * @file JpegImageCallback.h
 * @brief JpegImageCallback interface.
*/

#ifndef _MTK_LEGACYPIPELINE_STEREO_SHOT_JPEG_IMETACALLBACK_H_
#define _MTK_LEGACYPIPELINE_STEREO_SHOT_JPEG_IMETACALLBACK_H_
...
********************************************************************************/
/**
 * @class JpegImageCallback
 * @brief Processing Jpeg image callback.
 */
class JpegImageCallback : public IImageShotCallback
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Instantiation.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
// Constructor
    JpegImageCallback() = delete;
    JpegImageCallback(ImageCallbackParams params);

protected:
// Destructor
   virtual ~JpegImageCallback();
