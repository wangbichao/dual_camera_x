...
/**
 * @file ExtraDataImageCallback.h
 * @brief ExtraDataImageCallback interface.
*/

#ifndef _MTK_LEGACYPIPELINE_STEREO_SHOT_EXTRA_DATA_IMETACALLBACK_H_
#define _MTK_LEGACYPIPELINE_STEREO_SHOT_EXTRA_DATA_IMETACALLBACK_H_
 ...
 */
class ExtraDataImageCallback : public IImageShotCallback
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Instantiation.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
// Constructor
    ExtraDataImageCallback() = delete;
    ExtraDataImageCallback(ImageCallbackParams params);

protected:
// Destructor
   virtual ~ExtraDataImageCallback();
