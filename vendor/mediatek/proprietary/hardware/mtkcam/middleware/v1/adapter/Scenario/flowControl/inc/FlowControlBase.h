...
protected:
    ...
    android::sp<IScenarioControl>               enterScenarioControl(MINT32 scenario, const MSize &sensorSize, const MINT32 &sensorFps, MINT32 featureconfig = 0, MSize videoSize = MSize(0,0));
