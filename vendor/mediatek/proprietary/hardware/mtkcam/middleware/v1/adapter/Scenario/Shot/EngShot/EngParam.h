...
struct EngParam
{
    ...
    MINT32                          u4rawStride;
    MINT32                          u4EVvalue;
    int32_t                         mi4EngRawEVBEn;
    String8                         ms8RawFilePath;
    MINT32                          mi4MFLLpc;
    MUINT32                         u4ISPProfile;
    MBOOL                           bIsAutoHDR;
...
public:     ////                    Instantiation.
                                    EngParam(
                                        ...
                                        MINT32 const                   _u4EVvalue = 0,
                                        int32_t const                   i4EngRawEVBEn=0,
                                        String8 const                   s8RawFilePath = String8::format("/storage/sdcard/DCIM/CameraEM/engshot.raw"),
                                        MINT32  const                   i4MFLLnum = 0,
                                        MUINT32 const                  _u4ISPProfile = 1,
                                        MBOOL   const                  _bIsAutoHDR = MFALSE
                                    )
                                        ...
                                        , u4EVvalue(_u4EVvalue)
                                        , mi4EngRawEVBEn(i4EngRawEVBEn)
                                        , ms8RawFilePath(s8RawFilePath)
                                        , mi4MFLLnum(i4MFLLnum)
                                        , u4ISPProfile(_u4ISPProfile)
                                        , bIsAutoHDR(_bIsAutoHDR)
                                    {
                                    }
