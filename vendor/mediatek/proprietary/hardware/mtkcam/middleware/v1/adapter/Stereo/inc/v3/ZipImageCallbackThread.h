...
class ZipImageCallbackThread : public Thread
{
    public:
        typedef enum
        {
            ...
            callback_type_metadata_3rdparty,
            // exit type
            callback_type_exit,
        }callback_type;
    ...
    protected:  ////                Data Members.
        ...
        uint32_t                    mu4ShotMode             = 0;
        IState::ENState             mNextState              = IState::eState_Idle;
        bool                        mIsExtCallback          = false;
    ...
    protected:
        ...
        bool        handleMetadataCallback(callback_data& data);
