...
#ifndef _MTK_CAMERA_CAMADAPTER_SCENARIO_SHOT_ZSDVENDORSHOT_H_
#define _MTK_CAMERA_CAMADAPTER_SCENARIO_SHOT_ZSDVENDORSHOT_H_
 ...
 *
 ******************************************************************************/
class ZvCallbackListener
{
public:
    virtual         ~ZvCallbackListener() {}
public:
...
*
********************************************************************************/
class ZvImageCallback
    : public IImageCallback
{
public:
                                        ZvImageCallback(
                                            ZvCallbackListener* pListener,
                                            MUINT32 const data
                                            )
...
protected:  //// handle setting
    ...
    MBOOL           applyRawBufferSettings( Vector< SettingSet > vSettings,MINT32 shotCount );
...
protected:
    ...
    struct EncJob {
        ...
        MBOOL                           isReady()
                                        {
                                            if ( !mSrcCnt || mSrcCnt!=mvSource.size() )
                                                return MFALSE;
                                            //
                                            Mutex::Autolock _l(mLock);
...
protected:
    ...
    sp<ZvImageCallback>                                 mpImageCallback;
    sp<BufferCallbackHandler>                           mpCallbackHandler;
    sp<ZvMetadataListener>                              mpMetadataListener;
    //
...
#endif  //  _MTK_CAMERA_CAMADAPTER_SCENARIO_SHOT_ZSDVENDORSHOT_H_
