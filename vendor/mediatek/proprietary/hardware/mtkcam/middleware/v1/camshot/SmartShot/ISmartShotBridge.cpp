...
ICamShot*
ISmartShot::
createInstance(EShotMode const eShotMode, char const*const szCamShotName, MUINT32 sensorId, MUINT32 mfb, MBOOL *pIsMfb, EPipelineMode const ePipelineMode)
{
...
lbExit:
    if(frameNumber > 1) {
        ...
        pICamShot = ISingleShot::createInstance(eShotMode, szCamShotName, ePipelineMode);
