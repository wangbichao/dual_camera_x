...
public:     ////                    Attributes.
    ...
    virtual uint32_t                getImgWidth()       const               {
        return (mpImgInfo->mi4Orientation & HAL_TRANSFORM_ROT_90) ?
            mpImgInfo->mu4ImgHeight : mpImgInfo->mu4ImgWidth;
    }
    virtual uint32_t                getImgHeight()      const               {
        return (mpImgInfo->mi4Orientation & HAL_TRANSFORM_ROT_90) ?
            mpImgInfo->mu4ImgWidth : mpImgInfo->mu4ImgHeight;
    }
