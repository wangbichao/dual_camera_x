...
*
*******************************************************************************/
bool PreviewFeatureBase::initBuffers(sp<IImgBufQueue>const &rpBufQueue)
{
...
*
*******************************************************************************/
void PreviewFeatureBase::uninitBuffers()
{
    destroyBuffers();
...
*
*******************************************************************************/
bool PreviewFeatureBase::createBuffers()
{
...
bool PreviewFeatureBase::createWorkingBuffers(sp<IImgBufQueue>const & rpBufQueue)
{
    ...
    size_t const bufsize = (( bpp
                            ...
                            * bufHeight ) >> 3);
    //
    MY_LOGD("[PreviewFeature buffer] w: %d, h: %d, format: %s size: %z", bufWidth, bufHeight, format.string(), bufsize);
    //
    bufCnt = 2;
    for (int i = 0; i < bufCnt; i++)
    {
        sp<PREVIEWFEATUREBuffer> one = new PREVIEWFEATUREBuffer(bufWidth, bufHeight,
                       bpp,
                       bufsize,
                       imgFormat,format,"PREVIEWFEATUREBuffer");
...
*
*******************************************************************************/
void PreviewFeatureBase::destroyBuffers()
{
...
*
*******************************************************************************/
void PreviewFeatureBase::destroyWorkingBuffers()
{
...
*
*******************************************************************************/
bool PreviewFeatureBase::handleReturnBuffers(sp<IImgBufQueue>const& rpBufQueue, ImgBufQueNode const &rQueNode)
{
    bool ret = true;
...
* or by previewclient.
*******************************************************************************/
bool PreviewFeatureBase::waitAndHandleReturnBuffers(sp<IImgBufQueue>const& rpBufQueue, ImgBufQueNode &rQueNode)
{
    bool ret = false;
