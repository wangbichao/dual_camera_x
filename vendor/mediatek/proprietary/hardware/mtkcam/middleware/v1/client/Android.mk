...
-include $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/middleware/v1/client.mk
...
ifeq "'1'" "$(strip $(MTKCAM_HAVE_PREVIEWFEATURE_CLIENT))"
    ...
    LOCAL_SHARED_LIBRARIES += libcam.featureio.pipe.panorama
endif
#
# Preview Callback Client
...
ifeq "'1'" "$(strip $(MTKCAM_HAVE_OT_CLIENT))"
    ...
    LOCAL_SHARED_LIBRARIES += libcam.feature.ot
endif
#
#-----------------------------------------------------------
