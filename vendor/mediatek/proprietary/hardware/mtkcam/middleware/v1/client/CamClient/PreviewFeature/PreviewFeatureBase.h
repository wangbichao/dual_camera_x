...
#include <mtkcam/middleware/v1/client/IPreviewFeatureClient.h>
//
...
namespace NSPreviewFeatureBase {
/******************************************************************************
 *
 ******************************************************************************/
class ImgBufManager;
 ...
 ******************************************************************************/
class PreviewFeatureBase : public IPREFEATUREClient
                     , public Thread
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
...
public:     ////                    Instantiation.
    //
                     PreviewFeatureBase(sp<IParamsManager> pParamsMgr);
    virtual          ~PreviewFeatureBase();
...
public:     ////
    ...
    static  MBOOL    handlePanoImgCallBack(MVOID* const puJpegBuf,MINT32 puJpegBufMemID, int u4SrcWidth, int u4SrcHeight);
...
protected:  ////                    Operations.
    ...
    virtual void                    postCommand(CMD_Q_T &cmdQ);
    virtual bool                    getCommand(CMD_Q_T &cmdQ);
    //
    static void*                    onClientThreadLoopFunc(void *arg);
...
protected:  ////                    Data Members.
    ...
    int32_t                         mi4ThreadId;
    pthread_t                       onClientThreadLoopThread;
...
private:
    static MVOID*                   capDoneCBThreadFunc(void *arg);
