...
)
{
    ...
    // Node
    {
        ...
        usageHint.mEisMode = mConfigParams.eisMode;
        if (::property_get_int32("camera.3dnr.debug.level", 0))
            usageHint.m3DNRMode |= P2FeatureNode::E3DNR_MODE_MASK_HAL_FORCE_SUPPORT;
        #ifdef MTKCAM_SUPPORT_3DNR
            usageHint.m3DNRMode |= P2FeatureNode::E3DNR_MODE_MASK_UI_SUPPORT;
        #endif
        if (::property_get_int32("debug.3dnr.sl2e.enable", 1)) // sl2e: default on
            usageHint.m3DNRMode |= P2FeatureNode::E3DNR_MODE_MASK_SL2E_EN;
        #endif // FEATURE_MODIFY
