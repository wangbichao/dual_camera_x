 ...
 */
#define LOG_TAG "ContextBuilder/JpgEncBokehNodeData"
//
...
//
#include "JpegEnc_BokehNodeConfigData.h"
/******************************************************************************
 *
 ******************************************************************************/
    ...
    PipelineContext* pipeContext)
{
    ...
    if(metaManager != NULL)
    {
        ...
        cfgParam.pInAppMeta = metaManager->getStreamInfoByStreamId(eSTREAMID_META_APP_DYNAMIC_BOKEH);
        ...
        //
        cfgParam.pOutAppMeta = metaManager->getStreamInfoByStreamId(eSTREAMID_META_APP_DYNAMIC_BOKEH_JPG);
    ...
    if(imageManager != NULL)
    {
        ...
        cfgParam.pInYuv_Main = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_BOKEHNODE_RESULTYUV);
        addStream(cfgParam.pInYuv_Main, MTRUE);
        // pInYuv_Thumbnail is need input from bokeh node.
        ...
        //
        cfgParam.pOutJpeg = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_JPG_Bokeh);
