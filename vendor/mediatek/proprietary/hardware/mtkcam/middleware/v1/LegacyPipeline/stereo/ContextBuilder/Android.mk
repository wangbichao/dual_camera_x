...
LOCAL_SRC_FILES += ./NodeData/DualYUVNodeConfigData.cpp
#
ifeq ($(MTK_CAM_STEREO_DENOISE_SUPPORT), yes)
LOCAL_SRC_FILES += ./NodeData/BMDeNoiseNodeConfigData.cpp
LOCAL_SRC_FILES += ./NodeData/BMDepthMapNodeConfigData.cpp
LOCAL_SRC_FILES += ./NodeData/BMPreProcessNodeConfigData.cpp
