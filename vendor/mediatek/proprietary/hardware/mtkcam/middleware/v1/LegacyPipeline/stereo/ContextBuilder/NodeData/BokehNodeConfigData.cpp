    ...
    PipelineContext* pipeContext)
{
    ...
    if(metaManager != NULL)
    {
        ...
        //
        cfgParam.pInHalMeta = metaManager->getStreamInfoByStreamId(eSTREAMID_META_HAL_DYNAMIC_DEPTH);
        addStream(cfgParam.pInHalMeta, MTRUE);
        cfgParam.pInHalMeta_P1 = metaManager->getStreamInfoByStreamId(eSTREAMID_META_HAL_DYNAMIC_P1);
        addStream(cfgParam.pInHalMeta_P1, MTRUE);
        //
    ...
    if(imageManager != NULL)
    {
        ...
        //
        cfgParam.pInHalImageDMBG = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_DMBGYUV);
        addStream(  cfgParam.pInHalImageDMBG, MTRUE);
        //
        ...
        //
        cfgParam.pOutHalImageBokehThumbnail = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_YUV_THUMBNAIL);
        addStream(  cfgParam.pOutHalImageBokehThumbnail, MFALSE);
        //
