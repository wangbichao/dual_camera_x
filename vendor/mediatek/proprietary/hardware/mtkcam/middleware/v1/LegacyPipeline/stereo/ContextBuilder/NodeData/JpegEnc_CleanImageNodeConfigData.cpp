 ...
 */
#define LOG_TAG "ContextBuilder/JpgEncCleanNodeData"
//
...
//
#include "JpegEnc_CleanImageNodeConfigData.h"
//
/******************************************************************************
 *
 ******************************************************************************/
...
//
JpegEnc_CleanImageNodeConfigData::
JpegEnc_CleanImageNodeConfigData(
    MINT32 openId,
    NodeId_T nodeId,
    char const* nodeName)
    ...
    PipelineContext* pipeContext)
{
    ...
    if(imageManager != NULL)
    {
        ...
        cfgParam.pInYuv_Main = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_BOKEHNODE_CLEANIMAGEYUV);
        addStream(cfgParam.pInYuv_Main, MTRUE);
        //
        cfgParam.pOutJpeg = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_JPG_CleanMainImg);
