 ...
 */
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_BMDEPTHMAP_NODE_CONFIG_DATA_H_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_BMDEPTHMAP_NODE_CONFIG_DATA_H_
//
...
namespace v3
{
class BMDepthMapNodeConfigData
    : public INodeConfigBase
{
    public:
        BMDepthMapNodeConfigData(
                                ...
                                NodeId_T nodeId,
                                char const* nodeName);
        virtual ~BMDepthMapNodeConfigData();
    ...
    private:
        BMDepthMapNode::InitParams initParam;
        BMDepthMapNode::ConfigParams cfgParam;
};
};
};
