 ...
 */
#define LOG_TAG "ContextBuilder/DualImageNodeData"
//
...
//
#include "DualImageTransformNodeConfigData.h"
//
/******************************************************************************
 *
 ******************************************************************************/
...
//
typedef DualImageTransformNode          NodeT;
typedef NodeActor< NodeT >              MyNodeActorT;
//
DualImageTransformNodeConfigData::
DualImageTransformNodeConfigData(
    MINT32 openId,
    NodeId_T nodeId,
    char const* nodeName)
    ...
    PipelineContext* pipeContext)
{
    ...
    if(metaManager != NULL)
    {
        ...
        cfgParam.pOutAppMeta = metaManager->getStreamInfoByStreamId(eSTREAMID_META_APP_DYNAMIC_DUALIT);
        ...
        MY_LOGD_IF(cfgParam.pOutHalMeta == nullptr, "cfgParam.pOutHalMeta==nullptr");
    ...
    if(imageManager != NULL)
    {
        ...
        cfgParam.pInHalImageJpsMain1 = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_JPSMAIN1YUV);
        addStream(cfgParam.pInHalImageJpsMain1, MTRUE);
        //
        cfgParam.pInHalImageJpsMain2 = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_JPSMAIN2YUV);
        addStream(cfgParam.pInHalImageJpsMain2, MTRUE);
        //
        cfgParam.pOutHalImageJPS = imageManager->getStreamInfoByStreamId(eSTREAMID_IMAGE_PIPE_DUALIMAGETRANSFORM_JPSYUV);
        addStream(  cfgParam.pOutHalImageJPS, MFALSE);
        addStreamEnd(MFALSE);
    }
}
//
...
destroy()
{
    ...
    cfgParam.pInHalImageJpsMain1 = NULL;
    cfgParam.pInHalImageJpsMain2 = NULL;
    cfgParam.pOutHalImageJPS = NULL;
