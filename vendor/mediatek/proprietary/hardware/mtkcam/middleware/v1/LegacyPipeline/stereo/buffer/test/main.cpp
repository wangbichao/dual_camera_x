...
TEST(StereoBufferProviders, selectorTest){
    ...
    sp<StereoBufferPool> mpStereoBufferPool_OPAQUE= StereoBufferPool::createInstance(pImage_ImgoRaw->getStreamName(), pImage_ImgoRaw);
    mpStereoBufferPool_OPAQUE->setSelector(mpStereoSelector_OPAQUE);

    sp<StereoBufferPool> mpStereoBufferPool_RESIZER= StereoBufferPool::createInstance(pImage_RrzoRaw->getStreamName(), pImage_ImgoRaw);
    mpStereoBufferPool_RESIZER->setSelector(mpStereoSelector_RESIZER);

    sp<StereoBufferPool> mpStereoBufferPool_RESIZER_MAIN2 = StereoBufferPool::createInstance(pImage_RrzoRaw_main2->getStreamName(), pImage_ImgoRaw);
