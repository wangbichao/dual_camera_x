...
getRequest(MUINT32 const& requestId, IMetadata &nextAppRequest, IMetadata &nextHalRequest)
{
...

    {
        ...
        if(mRequestCnt == 0)
        {
            ...
            mpParamsMgrV3->getCropRegion(tempReqCropRegion,
        ...
        }
        {
            ...
            entry1.push_back(mReqCropRegion, Type2Type<MRect>());
        ...
        }
        {
            ...
            {
                entry1.push_back(mReqSensorCropRegion, Type2Type<MRect>());
            }
            ...
            case IRequestCallback::MSG_START_ZOOM :
                {
                    ...
                    mpParamsMgrV3->getCropRegion(reqCropRegion, reqSensorCropRegion, reqPreviewCropRegion, reqSensorPreviewCropRegion);
                    //
                    {
                    ...
                    //
                    {
                        ...
                        nextAppRequest.update(MTK_3A_PRV_CROP_REGION, entry);
                        List<IMetadata>::iterator iter = mRepeatingRequests.begin();
                        while( iter != mRepeatingRequests.end() ) {
