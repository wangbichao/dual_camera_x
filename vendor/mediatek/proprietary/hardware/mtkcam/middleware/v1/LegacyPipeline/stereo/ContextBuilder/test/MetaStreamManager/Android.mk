...
#-----------------------------------------------------------
LOCAL_SRC_FILES += Suite_TestMetaStreamManager.cpp
LOCAL_SRC_FILES += Suite_TestImageStreamManager.cpp
#[CKH need UT]LOCAL_SRC_FILES += Suite_TestContextBuilder.cpp
...
LOCAL_MODULE := stereo_metastreammanager
