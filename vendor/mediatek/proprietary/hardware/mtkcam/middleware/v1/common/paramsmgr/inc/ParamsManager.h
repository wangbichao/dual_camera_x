...
public:     ////                        Operations.
    ...
    virtual bool                        getSingleFrameCaptureHDR() const;
    virtual bool                        getHDRDetectionSupported() const;
    virtual NSCam::HDRMode              getHDRMode() const;
...
protected:  ////                        Update Params based on FeatureInfo
    ...
    bool                                updateSingleFrameCaptureHDRParams(NSCameraFeature::FeatureInfo const& rFeatureInfo);
    bool                                updateSensorSupportMZAF(NSCameraFeature::FeatureInfo const& rFeatureInfo);
    bool                                updateHDRDetectionParams(NSCameraFeature::FeatureInfo const& rFeatureInfo);
