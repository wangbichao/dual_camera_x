...
ifeq ($(MTK_TARGET_PROJECT),k35v1_op01_qhd_512m)
    LOCAL_CPPFLAGS += -DPROJECT_k35v1_op01_qhd_512m
endif

ifeq ($(MTK_TARGET_PROJECT),k35v1_op02_qhd_512m)
    LOCAL_CPPFLAGS += -DPROJECT_k35v1_op02_qhd_512m
endif

ifeq ($(MTK_TARGET_PROJECT),k35v1_op09_qhd_svlte_gmo_512m)
    LOCAL_CPPFLAGS += -DPROJECT_k35v1_op09_qhd_svlte_gmo_512m
endif
...
LOCAL_CFLAGS += -DHDR_DETECTION_MODE=$(MTK_CAM_HDR_DETECTION_MODE)
...
ifeq ($(MTK_CAM_SD_SUPPORT),yes)
	LOCAL_CFLAGS += -DSMILE_SHOT_SUPPORTED=1
endif
