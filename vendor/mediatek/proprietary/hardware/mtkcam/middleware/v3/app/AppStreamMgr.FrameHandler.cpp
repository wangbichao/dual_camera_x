...
dump() const
{
    ...
    {
        MUINT32 const frameNo = (*itFrame)->frameNo;
        MY_LOGD("frameNo:%u shutter:%" PRId64 " errors:%#x", (*itFrame)->frameNo, (*itFrame)->timestampShutter, (*itFrame)->errors.value);
        //
        //  Input Image
        {
            ...
            for (size_t i = 0; i < rItems.size(); i++) {
                ...
                if  ( pItem ) {
                    MY_LOGD("\t\t streamId:%#" PRIxPTR " "
                        ...
                        streamId, pItem->state, pItem->history.value, pItem->buffer.get(),
