...
#ifndef _MTK_HARDWARE_MTKCAM_MAIN_HAL_MODULE_DEPEND_CAMDEVICEMANAGERIMP_H_
#define _MTK_HARDWARE_MTKCAM_MAIN_HAL_MODULE_DEPEND_CAMDEVICEMANAGERIMP_H_
//
...
#endif  //_MTK_HARDWARE_MTKCAM_MAIN_HAL_MODULE_DEPEND_CAMDEVICEMANAGERIMP_H_
