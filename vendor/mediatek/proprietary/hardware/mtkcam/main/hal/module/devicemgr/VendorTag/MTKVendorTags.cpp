...
const Entry MTKFaceFeature[MTK_FACE_FEATURE_END - MTK_FACE_FEATURE_START] = {
    ...
    [MTK_FACE_FEATURE_FORCE_FACE_3A - MTK_FACE_FEATURE_START] =
        {"forceface3a",   TYPE_INT32},
    [MTK_FACE_FEATURE_AVAILABLE_FORCE_FACE_3A - MTK_FACE_FEATURE_START] =
...
const Entry MTKHDRFeature[MTK_HDR_FEATURE_END - MTK_HDR_FEATURE_START] = {
    [MTK_HDR_FEATURE_HDR_MODE - MTK_HDR_FEATURE_START] =
        {"hdrMode",   TYPE_INT32},
    [MTK_HDR_FEATURE_VHDR_MODE - MTK_HDR_FEATURE_START] =
        {"vhdrMode",   TYPE_INT32},
    [MTK_HDR_FEATURE_AVAILABLE_HDR_MODES - MTK_HDR_FEATURE_START] =
        {"availableHdrModes",   TYPE_INT32},
    [MTK_HDR_FEATURE_AVAILABLE_VHDR_MODES - MTK_HDR_FEATURE_START] =
        {"availableVhdrModes",   TYPE_INT32}
};

const Entry MTKStereoFeature[MTK_STEREO_FEATURE_END - MTK_STEREO_FEATURE_START] = {
    [MTK_STEREO_FEATURE_DOF_LEVEL - MTK_STEREO_FEATURE_START] =
        {"doflevel",    TYPE_INT32},
    [MTK_STEREO_FEATURE_SUPPORTED_DOF_LEVEL - MTK_STEREO_FEATURE_START] =
        {"supporteddoflevel", TYPE_INT32},
    [MTK_STEREO_FEATURE_RESULT_DOF_LEVEL - MTK_STEREO_FEATURE_START] =
        {"resultdoflevel", TYPE_INT32},
    [MTK_STEREO_FEATURE_WARNING - MTK_STEREO_FEATURE_START] =
        {"stereowarning", TYPE_INT32},
    [MTK_STEREO_FEATURE_DEPTH_AF_ON - MTK_STEREO_FEATURE_START] =
        {"depthafon", TYPE_INT32},
    [MTK_STEREO_FEATURE_DISTANCE_MEASURE_ON - MTK_STEREO_FEATURE_START] =
        {"distancemeasureon", TYPE_INT32},
    [MTK_STEREO_FEATURE_RESULT_DISTANCE - MTK_STEREO_FEATURE_START] =
        {"resultdistance", TYPE_FLOAT},
    [MTK_STEREO_FEATURE_TOUCH_POSITION - MTK_STEREO_FEATURE_START] =
...
const Section MTKSections[MTK_VENDOR_SECTION_COUNT] = {
    ...
    [MTK_NR_FEATURE] = { "com.mediatek.nrfeature",
                        ...
                        MTKNRFeature },
    [MTK_STEREO_FEATURE] = { "com.mediatek.stereofeature",
                        (uint32_t)MTK_STEREO_FEATURE_START,
                        (uint32_t)MTK_STEREO_FEATURE_END,
                        MTKStereoFeature },
    [MTK_HDR_FEATURE] = { "com.mediatek.hdrfeature",
                        (uint32_t)MTK_HDR_FEATURE_START,
                        (uint32_t)MTK_HDR_FEATURE_END,
                        MTKHDRFeature },
};
