...
namespace NSACDK
{
    ...
    public:
        ...
        /**
              ...
              */
        AcdkMain (ACDK_BYPASS_FLAG bypassFlag = ACDK_BYPASS_NONE);
    ...
    private:
        ...
        /**
                ...
                *-0 indicates success, otherwise indicates fail
              */
        virtual MINT32 saveJPEGImg(MUINTPTR CompressBufVA, MUINT32 CompressSize);
        ...
        /**
                *@brief Create memory by using AMem
                *
                ...
                *@param[in,out] bufInfo : pointer to AMEM_BUF_INFO
                *
                *@return
                *-0 indicates success, otherwise indicates fail
              */
        MINT32 createMemBuf(MUINT32 &memSize, MUINT32 bufCnt, AMEM_BUF_INFO *bufInfo);

        /**
                *@brief Destroy memory by using AMem
                *
                ...
                *-0 indicates success, otherwise indicates fail
              */
        MINT32 destroyMemBuf(MUINT32 bufCnt, AMEM_BUF_INFO *bufInfo);
	...
	void setScenario(MUINT32 const mode, MUINT32 &DestScenario);
        ...
        AMEM_BUF_INFO mPrvIMemInfo[OVERLAY_BUFFER_CNT];
        AMEM_BUF_INFO mDispIMemInfo[OVERLAY_BUFFER_CNT];
        AMEM_BUF_INFO mPrvIMemInfoRRZO[OVERLAY_BUFFER_CNT];
        AMEM_BUF_INFO mCapIMemInfo;

        //capture buffer
        AMEM_BUF_INFO mRawIMemInfo;
        AMEM_BUF_INFO mJpgIMemInfo;
        AMEM_BUF_INFO mQvIMemInfo;

        //surface View
        AcdkSurfaceView *m_pAcdkSurfaceViewObj;
        AMEM_BUF_INFO mSurfaceIMemInfo[SURFACE_NUM];
        MUINT32 mLCMOrientation;
        MUINT32 mSurfaceIndex;

        //sensor Info
        NSCam::SensorStaticInfo sensorStaticInfo[3];
