...
#define DUMMY_RRZ_W         (128)
#define DUMMY_RRZ_H         (128)
...
namespace NSAcdkMhal
{
    ...
    typedef struct acdkMhalPrvParam_s
    {
        ...
        AMEM_BUF_INFO *imgImemBuf;
        AMEM_BUF_INFO *rrzoImemBuf;
        AMEM_BUF_INFO *dispImemBuf;
    ...
    public:
            ...
            /**
                       ...
                       *-0 indicates success, otherwise indicates fail
                     */
            virtual MUINT32 acdkMhalGetCaptureRaw(AMEM_BUF_INFO* pCapBufInfo, AMEM_BUF_INFO* pQvBufInfo, MUINT32 Format) = 0;
