...
EFFECTHAL_CFB_SUPPORT := '0'
PLATFORM := $(shell echo $(MTK_PLATFORM) | tr A-Z a-z)
ifeq ($(PLATFORM), $(filter $(PLATFORM),mt6797)) #mt6797 is special case
EFFECTHAL_CFB_SUPPORT := '0'
else
ifeq ($(MTK_CAM_FACEBEAUTY_SUPPORT), yes)
EFFECTHAL_CFB_SUPPORT := '1'
endif
endif
LOCAL_CFLAGS += -DEFFECTHAL_CFB_SUPPORT="$(EFFECTHAL_CFB_SUPPORT)"
$(info "CFB Effect Hal Support = $(EFFECTHAL_CFB_SUPPORT)")

#-----------------------------------------------------------
LOCAL_SRC_FILES += EffectFactory.cpp
