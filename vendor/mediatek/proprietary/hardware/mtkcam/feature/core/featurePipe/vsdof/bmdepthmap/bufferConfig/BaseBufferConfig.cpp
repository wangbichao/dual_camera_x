...
// bufferID inside the DataID : P2AFM_TO_N3D_FEFM_CCin
DepthMapBufferID bufIDs_P2AFM_TO_N3D_FEFM_CCin[] =
{
    BID_P2AFM_OUT_FE1BO, BID_P2AFM_OUT_FE2BO, BID_P2AFM_OUT_FE1CO, BID_P2AFM_OUT_FE2CO,
    BID_P2AFM_OUT_RECT_IN1, BID_P2AFM_OUT_RECT_IN2, BID_P2AFM_OUT_CC_IN1, BID_P2AFM_OUT_CC_IN2,
    BID_P2AFM_OUT_FMBO_LR, BID_P2AFM_OUT_FMBO_RL, BID_P2AFM_OUT_FMCO_LR, BID_P2AFM_OUT_FMCO_RL,
    // end with this
    BID_INVALID
};

DepthMapBufferID bufIDs_P2AFM_TO_WMF_MY_SL[] =
{
    BID_P2AFM_OUT_MY_SL,
    // end with this
    BID_INVALID
...
DepthMapBufferID bufIDs_P2AFM_TO_FD_IMG[] =
{
    BID_P2AFM_OUT_FDIMG,
    // end with this
    BID_INVALID
...
DepthMapBufferID bufIDs_OCC_TO_WMF_DMH_MY_S[] =
{
    BID_OCC_OUT_DMH, BID_OCC_OUT_MY_S,
    // end with this
    BID_INVALID
};

DepthMapBufferID bufIDs_P2AFM_OUT_MV_F[] =
{
    BID_P2AFM_OUT_MV_F,
    // end with this
    BID_INVALID
...
DepthMapBufferID bufIDs_P2AFM_OUT_FD[] =
{
    BID_P2AFM_OUT_FDIMG,
    // end with this
    BID_INVALID
...
DepthMapBufferID bufIDs_P2AFM_OUT_MV_F_CAP[] =
{
...
DepthMapBufferID bufIDs_WMF_OUT_DMW_MY_S[] =
{
    BID_OCC_OUT_MY_S, BID_WMF_OUT_DMW,
    // end with this
    BID_INVALID
};

DepthMapBufferID bufIDs_WMF_OUT_DEPTHMAP[] =
{
...
DepthMapBufferID bufIDs_N3D_OUT_JPS_WARPING_MATRIX[] =
{
...
{
    BID_P2AFM_IN_FSRAW1, BID_P2AFM_IN_FSRAW2,
    BID_P2AFM_IN_RSRAW1, BID_P2AFM_IN_RSRAW2,
    // end with this
    BID_INVALID
};
...
{
    BID_P2AFM_FE2B_INPUT, BID_P2AFM_FE1B_INPUT,
    // end with this
    BID_INVALID
};
...
DataIDToBIDMap getDataIDToBIDMap()
{
    ...
    ADD_TO_DBIDMAP(P2AFM_TO_N3D_FEFM_CCin);
    ADD_TO_DBIDMAP(P2AFM_TO_WMF_MY_SL);
    ADD_TO_DBIDMAP(P2AFM_TO_FD_IMG);
    ADD_TO_DBIDMAP(N3D_TO_DPE_MVSV_MASK);
    ADD_TO_DBIDMAP(N3D_TO_OCC_LDC);
    ADD_TO_DBIDMAP(DPE_TO_OCC_MVSV_DMP_CFM);
    ADD_TO_DBIDMAP(OCC_TO_WMF_DMH_MY_S);
    ADD_TO_DBIDMAP(P2AFM_OUT_MV_F);
    ADD_TO_DBIDMAP(P2AFM_OUT_FD);
    ADD_TO_DBIDMAP(P2AFM_OUT_MV_F_CAP);
    ADD_TO_DBIDMAP(WMF_OUT_DMW_MY_S);
    ADD_TO_DBIDMAP(WMF_OUT_DEPTHMAP);
    ADD_TO_DBIDMAP(FD_OUT_EXTRADATA);
    ADD_TO_DBIDMAP(N3D_OUT_JPS_WARPING_MATRIX);
