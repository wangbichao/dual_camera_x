...
public:
    ...
    MVOID setUsageHint(const IStreamingFeaturePipe::UsageHint &usage);
...
protected:
    ...
    MBOOL dumpData(const RequestPtr &request, IImageBuffer *buffer, const char *fmt, ...);
