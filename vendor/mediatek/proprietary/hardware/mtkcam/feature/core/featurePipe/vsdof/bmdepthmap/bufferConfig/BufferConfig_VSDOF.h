...
{
    // input
    {BID_P2AFM_IN_FSRAW1, eBUFFER_IOTYPE_INPUT},
    {BID_P2AFM_IN_FSRAW2, eBUFFER_IOTYPE_INPUT},
    {BID_P2AFM_IN_RSRAW1, eBUFFER_IOTYPE_INPUT},
    {BID_P2AFM_IN_RSRAW2, eBUFFER_IOTYPE_INPUT},
    // output
    {BID_P2AFM_OUT_MV_F, eBUFFER_IOTYPE_OUTPUT},
    {BID_P2AFM_OUT_FDIMG, eBUFFER_IOTYPE_OUTPUT},
    {BID_OCC_OUT_MY_S, eBUFFER_IOTYPE_OUTPUT},
    {BID_WMF_OUT_DMW, eBUFFER_IOTYPE_OUTPUT},
...
const NodeBufferSetting capture_buffer_config[] =
{
    ...
    {BID_P2AFM_IN_RSRAW2, eBUFFER_IOTYPE_INPUT},
    // output
    {BID_P2AFM_OUT_MV_F_CAP, eBUFFER_IOTYPE_OUTPUT},
    {BID_N3D_OUT_LDC, eBUFFER_IOTYPE_OUTPUT},
    {BID_OCC_OUT_MY_S, eBUFFER_IOTYPE_OUTPUT},
    {BID_WMF_OUT_DMW, eBUFFER_IOTYPE_OUTPUT},
    {BID_N3D_OUT_JPS_MAIN1, eBUFFER_IOTYPE_OUTPUT},
    {BID_N3D_OUT_JPS_MAIN2, eBUFFER_IOTYPE_OUTPUT},
    {BID_WMF_OUT_DEPTHMAP, eBUFFER_IOTYPE_OUTPUT},
