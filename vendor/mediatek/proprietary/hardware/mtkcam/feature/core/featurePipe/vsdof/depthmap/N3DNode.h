...
private:
    ...
    MBOOL prepareN3DOutputParam_CAP(N3D_HAL_OUTPUT_CAPTURE& rN3dParam, ImgInfoMapPtr pToDPEImgInfo);
    MBOOL prepareN3DOutputYUVMask(N3D_HAL_OUTPUT& rN3dParam, ImgInfoMapPtr pToDPEImgInfo);
