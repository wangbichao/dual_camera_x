...
class VSDOF_P2BNode : public BokehPipeNode
{
    ...
    private:        //
        ...
        //
        MVOID setting3DNR(nr3dConfigData config, QParams& rParams);
        //
        MBOOL removeInPortId(QParams& rParams, NSCam::NSIoPipe::PortID portId);
        MBOOL removeOutPortId(QParams& rParams, NSCam::NSIoPipe::PortID portId);
    ...
    private:
        ...
        //WaitQueue<SmartImageBuffer>                     mDMGBufQueue;
        //WaitQueue<SmartImageBuffer>                     mDMBGBufQueue;
        //WaitQueue<FrameInfoPtr>                         mDMGFrameInfo;
        //WaitQueue<FrameInfoPtr>                         mDMBGFrameInfo;
        //
        ...
        //
        //sp<IImageBuffer>                                mpInputFrame = nullptr;
        //sp<IImageBuffer>                                mpOutputFrame = nullptr;
        //
