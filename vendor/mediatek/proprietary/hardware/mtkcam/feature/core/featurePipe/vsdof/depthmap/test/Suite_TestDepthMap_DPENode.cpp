...
#include <mtkcam/feature/stereo/pipe/depthmap/DPENode.h>
...
MVOID prepareDPEInputImgInfoMap(ImgInfoMapPtr& pToDPEImgInfo, int index)
{
    ...
    snprintf(MVY_FileName, 256, "/sdcard/vsdof/DPE/m_pDown_R_%05d.yv12", index);
    snprintf(SVY_FileName, 256, "/sdcard/vsdof/DPE/m_pDown_L_%05d.yv12", index);
    snprintf(MASK_M_FileName, 256, "/sdcard/vsdof/DPE/mask_dv_R_%05d.raw", index);
    snprintf(MASK_S_FileName, 256, "/sdcard/vsdof/DPE/mask_dv_L_%05d.raw", index);
#else
