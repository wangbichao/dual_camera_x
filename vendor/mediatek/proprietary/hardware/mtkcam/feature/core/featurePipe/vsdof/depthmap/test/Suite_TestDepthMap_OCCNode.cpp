...
MVOID prepareOCCInputImgInfoMap(ImgInfoMapPtr& pToOCCImgInfoFromN3D, ImgInfoMapPtr& pToOCCImgInfoFromDPE, sp<EffectRequest> pEffReq)
{
    ...
    */
    ...
    pToOCCImgInfoFromN3D->addImageBuffer(BID_N3D_OUT_LDC, sm_LDC);
    ...
    pToOCCImgInfoFromDPE->addImageBuffer(BID_N3D_OUT_MV_Y, sm_MV_Y);
    pToOCCImgInfoFromDPE->addImageBuffer(BID_N3D_OUT_SV_Y, sm_SV_Y);
    pToOCCImgInfoFromDPE->addImageBuffer(BID_DPE_OUT_DMP_L, smImgBuf_DMP_L);
    pToOCCImgInfoFromDPE->addImageBuffer(BID_DPE_OUT_DMP_R, smImgBuf_DMP_R);

    //MY_S
    sp<EffectFrameInfo> frameInfo = new EffectFrameInfo(pEffReq->getRequestNo(), BID_OCC_OUT_MY_S);
    ...
    pEffReq->vOutputFrameInfo.add(BID_OCC_OUT_MY_S, frameInfo);
