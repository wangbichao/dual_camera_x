...
private:
    ...
    halFDBase* mpFDHalObj = NULL;
    MUINT8* mpFDWorkingBuffer = NULL;
    MUINT8* mpDDPBuffer = NULL;
    MUINT8* mpExtractYBuffer = NULL;
    MtkCameraFaceMetadata* mpDetectedFaces = NULL;
    JSON_Util* mpJsonUtil = NULL;
