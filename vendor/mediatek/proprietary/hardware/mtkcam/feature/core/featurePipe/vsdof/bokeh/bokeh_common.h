...
// input port
static const NSCam::NSIoPipe::PortID PORT_DMGI( NSCam::NSIoPipe::EPortType_Memory, NSImageio::NSIspio::EPortIndex_DMGI, 0); // DMG input
// output
static const NSCam::NSIoPipe::PortID PORT_WDMA( NSCam::NSIoPipe::EPortType_Memory, NSImageio::NSIspio::EPortIndex_WDMAO, 1);
static const NSCam::NSIoPipe::PortID PORT_WROT( NSCam::NSIoPipe::EPortType_Memory, NSImageio::NSIspio::EPortIndex_WROTO, 1);
