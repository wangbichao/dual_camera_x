...
public:
    ...
    static MBOOL configTuning_FE(eTarget target, dip_x_reg_t &tuning, MUINT32 mode);
    static MBOOL configTuning_FM(eTarget target, dip_x_reg_t &tuning, MSize FMSize, MUINT32 mode);
