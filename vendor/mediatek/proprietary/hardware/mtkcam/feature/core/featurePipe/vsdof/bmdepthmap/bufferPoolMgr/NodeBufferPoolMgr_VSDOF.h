...
private:
    ...
    typedef KeyedVector<BufferPoolScenario,sp<ImageBufferPool> > ScenarioToImgBufPoolMap;
    ...
    sp<ImageBufferPool> mpRectInBufPool_Main2_VR;
    sp<ImageBufferPool> mpRectInBufPool_Main1_PV;
    sp<ImageBufferPool> mpRectInBufPool_Main2_PV;
    ...
    //----------------------OCC section--------------------------------//
    sp<ImageBufferPool> mDMHImgBufPool;
    //----------------------WMF section--------------------------------//
    sp<ImageBufferPool> mpInternalDMWImgBufPool;
    sp<ImageBufferPool> mpInternalDepthMapImgBufPool;
