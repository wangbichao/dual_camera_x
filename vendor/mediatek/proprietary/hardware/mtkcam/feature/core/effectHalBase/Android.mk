...
LOCAL_SRC_FILES += $(EFFECTHAL_FW_VER)/EffectHalClient.cpp
LOCAL_SRC_FILES += $(EFFECTHAL_FW_VER)/EffectHalVersion.cpp
LOCAL_SRC_FILES += $(EFFECTHAL_FW_VER)/EffectRequest.cpp
LOCAL_SRC_FILES += $(EFFECTHAL_FW_VER)/IEffectFactory.cpp
LOCAL_SRC_FILES += $(EFFECTHAL_FW_VER)/IEffectHalClient.cpp
LOCAL_SRC_FILES += $(EFFECTHAL_FW_VER)/IEffectListener.cpp
