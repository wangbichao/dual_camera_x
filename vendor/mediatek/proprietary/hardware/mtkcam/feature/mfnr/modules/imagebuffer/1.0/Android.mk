...
LOCAL_MODULE := $(MFLL_LIB_NAME_IMAGEBUF)
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk

LOCAL_C_INCLUDES += $(MFLL_INCLUDE_PATH)

LOCAL_SRC_FILES := MfllImageBuffer.cpp

# workaround include path
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/hardware/mtkcam # workaround for INormalStream.h
...
# IImageBuffer
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/hardware/mtkcam/include/mtkcam/utils/std
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/hardware/mtkcam/include/mtkcam/utils/imgbuf
