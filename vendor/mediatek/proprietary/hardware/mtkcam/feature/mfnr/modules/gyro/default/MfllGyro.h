...
public:
    ...
    std::deque<MfllGyroInfo> getGyroInfo(
            int64_t ts_start    __attribute__((unused)),
            int64_t ts_end      __attribute__((unused))) const
    {
        return std::move(std::deque<MfllGyroInfo>());
    }

    std::deque<MfllGyroInfo> takeGyroInfo(
            int64_t ts_start        __attribute__((unused)),
            int64_t ts_end          __attribute__((unused)),
            bool clearInvalidated   __attribute__((unused)))
    {
        return std::move(std::deque<MfllGyroInfo>());
    }
    ...
    enum MfllErr sendCommand(
            const std::string& cmd_str          __attribute__((unused)),
