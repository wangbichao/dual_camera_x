...
protected:
    ...
    int             m_isFeedRaw; // represents is reading RAW from SDCARD or not
...
public:
    ...
    virtual bool isFeedRaw(void);
    virtual enum MfllErr readFeedRawConfiguration(MfllFeedRawConfig_t *config);
...
public:
    ...
    enum MfllErr doBss(void *void_frameCount);
