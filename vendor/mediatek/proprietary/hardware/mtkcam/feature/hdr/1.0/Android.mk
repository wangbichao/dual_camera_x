...
ifeq ($(TARGET_BOARD_PLATFORM), $(filter $(TARGET_BOARD_PLATFORM), mt6735m mt6737m mt6580 mt6570 mt8163))
...
ifeq ($(TARGET_BOARD_PLATFORM), $(filter $(TARGET_BOARD_PLATFORM), mt6580 mt6570 mt8163))
LOCAL_C_INCLUDES += \
