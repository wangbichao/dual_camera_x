...
JPGSDKCbFunc()
{
    ...
    if(mpisabort)
    {
        ALOGD("[%s] already aborted. do nothing.", __FUNCTION__);
        mpisabort = MFALSE;

    } else {
        ALOGD("[%s] start return onCompleted to AP.", __FUNCTION__);
    ...
    if (oFrameInfo != NULL && iFrameInfo != NULL)
    {
        ...
        if (mpOutputFrame != NULL && mpInputFrame != NULL)
        {
            ...
            if ((mpInputFrame->getImgFormat() != eImgFmt_I422) &&
                ...
                (mpInputFrame->getImgFormat() != eImgFmt_RGB888) &&
            ...
            if ((mpOutputFrame->getImgFormat() != eImgFmt_I422) &&
                ...
                (mpOutputFrame->getImgFormat() != eImgFmt_RGB888) &&
