...
#ifndef _MTK_HARDWARE_INCLUDE_MTKCAM_JPG_EFFECTHAL_H_
#define _MTK_HARDWARE_INCLUDE_MTKCAM_JPG_EFFECTHAL_H_
 ...
 ******************************************************************************/
namespace NSCam {
class JPGEffectHal : public EffectHalBase
{
public:
    JPGEffectHal();
    virtual ~JPGEffectHal();
public: //EffectHalBase
    ...
    virtual android::status_t   doJPG();
    virtual android::status_t   setCallback();
    virtual android::status_t   JPGSDKCbFunc();
...
#endif  //_MTK_HARDWARE_INCLUDE_MTKCAM_JPG_EFFECTHAL_H_
