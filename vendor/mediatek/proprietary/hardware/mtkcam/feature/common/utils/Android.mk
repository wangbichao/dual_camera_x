...
PROFILE_MT6797 := mt6797
PROFILE_MT6757 := mt6757 kiboplus

ifneq (,$(filter $(PROFILE_MT6797),$(PLATFORM)))
PROFILE_HELPER_FOLDER := mt6797
else ifneq (,$(filter $(PROFILE_MT6757),$(PLATFORM)))
PROFILE_HELPER_FOLDER := mt6757
else
#TODO  currently default use mt6757 folder
PROFILE_HELPER_FOLDER := mt6757
endif
...
LOCAL_SRC_FILES += $(PROFILE_HELPER_FOLDER)/FeatureProfileHelper.cpp
