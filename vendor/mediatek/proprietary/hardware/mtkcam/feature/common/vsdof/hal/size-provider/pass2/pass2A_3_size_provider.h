 ...
 ************************************************************************************************/
#ifndef _PASS2A_3_SIZE_PROVIDER_H_
#define _PASS2A_3_SIZE_PROVIDER_H_
...
public:
    ...
    virtual StereoArea getIMG2OArea( ENUM_STEREO_SCENARIO eScenario __attribute__((unused))) const {
        return StereoArea(MSize(128, 72))
    ...
    virtual StereoArea getFEOInputArea( ENUM_STEREO_SCENARIO eScenario ) const {
        return StereoArea(Pass2A_2_SizeProvider::instance()->getIMG2OArea(eScenario));
    }
