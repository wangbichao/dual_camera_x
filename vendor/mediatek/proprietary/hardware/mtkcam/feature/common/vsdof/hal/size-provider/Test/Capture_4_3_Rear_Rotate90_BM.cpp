...
class Capture_4_3_Rear_Rotate90_BM : public StereoSizeProviderUTBase
{
public:
    Capture_4_3_Rear_Rotate90_BM() : StereoSizeProviderUTBase() { init(); }

    virtual ~Capture_4_3_Rear_Rotate90_BM() {}
...
//  PASS 1
//=============================================================================
TEST_F(Capture_4_3_Rear_Rotate90_BM, TEST)
{
    if(ignoreTest()) {
    ...
    MYEXPECT_EQ( szRRZO[0],                                 MSize(2104, 1560)  );
    ...
    //=============================================================================
    //N3D Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MV_Y, eSTEREO_SCENARIO_CAPTURE),      StereoArea(360, 428, 48, 12, 24, 6));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_SV_Y, eSTEREO_SCENARIO_CAPTURE),      StereoArea(360, 428, 48, 12, 24, 6));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MASK_S_Y, eSTEREO_SCENARIO_CAPTURE),  StereoArea(360, 428, 48, 12, 24, 6));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_LDC, eSTEREO_SCENARIO_CAPTURE),       StereoArea(360, 428, 48, 12, 24, 6));
    ...
    //DPE Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMP_H, eSTEREO_SCENARIO_CAPTURE),     StereoArea(360, 428, 48, 12, 24, 6));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_CFM_H, eSTEREO_SCENARIO_CAPTURE),     StereoArea(360, 428, 48, 12, 24, 6));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_RESPO, eSTEREO_SCENARIO_CAPTURE),     StereoArea(360, 428, 48, 12, 24, 6));
}
