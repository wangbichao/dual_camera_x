...
//
#define LOG_TAG "PreviewFrameGenerator"
//
...
#define LOAD_DEPTH_BLUR_MAP(NAME, PATH)\
    do{\
    ...
    //
    LOAD_DEPTH_BLUR_MAP("DepthMap_0", "/sdcard/vsdof/bokeh_ut/data/Bmap_GF_00000.raw");
    LOAD_DEPTH_BLUR_MAP("DepthMap_1", "/sdcard/vsdof/bokeh_ut/data/Bmap_GF_00001.raw");
    LOAD_DEPTH_BLUR_MAP("DepthMap_2", "/sdcard/vsdof/bokeh_ut/data/Bmap_GF_00002.raw");
    LOAD_DEPTH_BLUR_MAP("DepthMap_3", "/sdcard/vsdof/bokeh_ut/data/Bmap_GF_00003.raw");
    LOAD_DEPTH_BLUR_MAP("DepthMap_4", "/sdcard/vsdof/bokeh_ut/data/Bmap_GF_00004.raw");
    LOAD_DEPTH_BLUR_MAP("DepthMap_5", "/sdcard/vsdof/bokeh_ut/data/Bmap_GF_00005.raw");
    LOAD_DEPTH_BLUR_MAP("DepthMap_6", "/sdcard/vsdof/bokeh_ut/data/Bmap_GF_00006.raw");
    LOAD_DEPTH_BLUR_MAP("DepthMap_7", "/sdcard/vsdof/bokeh_ut/data/Bmap_GF_00007.raw");
    LOAD_DEPTH_BLUR_MAP("DepthMap_8", "/sdcard/vsdof/bokeh_ut/data/Bmap_GF_00008.raw");
    LOAD_DEPTH_BLUR_MAP("DepthMap_9", "/sdcard/vsdof/bokeh_ut/data/Bmap_GF_00009.raw");
#undef LOAD_DEPTH_BLUR_MAP
    // dump image buffer
    /*makePath("/sdcard/vsdof/bokeh_ut/result/", 0660);
    string saveFileName = "";
...
#define CREATE_EMPTY_IMAGE_BUFFER(NAME)\
    do{\
        pImgBuffer = createEmptyImageBuffer(\
                        imgParam_PreviewImg,\
                        NAME,\
                        eBUFFER_USAGE_HW_CAMERA_WRITE|eBUFFER_USAGE_SW_READ_OFTEN|eBUFFER_USAGE_SW_WRITE_RARELY);\
        mvPreviewImageBuffer.push_back(pImgBuffer);\
    }while(0)
    CREATE_EMPTY_IMAGE_BUFFER("PRV_0");
    CREATE_EMPTY_IMAGE_BUFFER("PRV_1");
    CREATE_EMPTY_IMAGE_BUFFER("PRV_2");
    CREATE_EMPTY_IMAGE_BUFFER("PRV_3");
    CREATE_EMPTY_IMAGE_BUFFER("PRV_4");
    CREATE_EMPTY_IMAGE_BUFFER("PRV_5");
    CREATE_EMPTY_IMAGE_BUFFER("PRV_6");
    CREATE_EMPTY_IMAGE_BUFFER("PRV_7");
    CREATE_EMPTY_IMAGE_BUFFER("PRV_8");
    CREATE_EMPTY_IMAGE_BUFFER("PRV_9");
