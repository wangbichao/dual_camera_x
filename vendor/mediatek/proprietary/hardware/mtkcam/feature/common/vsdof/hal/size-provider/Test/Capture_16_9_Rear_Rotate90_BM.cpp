...
TEST_F(Capture_16_9_Rear_Rotate90_BM, TEST)
{
    ...
    //=============================================================================
    //N3D Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MV_Y, eSTEREO_SCENARIO_CAPTURE),      StereoArea(336, 496, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MASK_M_Y, eSTEREO_SCENARIO_CAPTURE),  StereoArea(336, 496, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_SV_Y, eSTEREO_SCENARIO_CAPTURE),      StereoArea(336, 496, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MASK_S_Y, eSTEREO_SCENARIO_CAPTURE),  StereoArea(336, 496, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_LDC, eSTEREO_SCENARIO_CAPTURE),       StereoArea(336, 496, 64, 16, 32, 8));
    ...
    //DPE Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMP_H, eSTEREO_SCENARIO_CAPTURE),     StereoArea(336, 496, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_CFM_H, eSTEREO_SCENARIO_CAPTURE),     StereoArea(336, 496, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_RESPO, eSTEREO_SCENARIO_CAPTURE),     StereoArea(336, 496, 64, 16, 32, 8));
}
