...
class Capture_16_9_Rear_Rotate0_BM : public StereoSizeProviderUTBase
{
public:
    Capture_16_9_Rear_Rotate0_BM() : StereoSizeProviderUTBase() { init(); }

    virtual ~Capture_16_9_Rear_Rotate0_BM() {}
...
//  PASS 1
//=============================================================================
TEST_F(Capture_16_9_Rear_Rotate0_BM, TEST)
{
    if(ignoreTest()) {
    ...
    // PASS2A'
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_P].areaWROT,           StereoArea(960, 544));
    ...
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_P_2].areaIMG2O,        StereoArea(480, 272));
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_P_2].areaFEO,          StereoArea(960, 544));
    ...
    MYEXPECT_EQ(pass2SizeInfo[PASS2A_P_3].areaFEO,          StereoArea(480, 272));
    ...
    //=============================================================================
    //N3D Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MV_Y, eSTEREO_SCENARIO_CAPTURE),      StereoArea(544, 288, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MASK_M_Y, eSTEREO_SCENARIO_CAPTURE),  StereoArea(544, 288, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_SV_Y, eSTEREO_SCENARIO_CAPTURE),      StereoArea(544, 288, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_MASK_S_Y, eSTEREO_SCENARIO_CAPTURE),  StereoArea(544, 288, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_LDC, eSTEREO_SCENARIO_CAPTURE),       StereoArea(544, 288, 64, 16, 32, 8));
    ...
    //DPE Output
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_DMP_H, eSTEREO_SCENARIO_CAPTURE),     StereoArea(544, 288, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_CFM_H, eSTEREO_SCENARIO_CAPTURE),     StereoArea(544, 288, 64, 16, 32, 8));
    MYEXPECT_EQ(sizeProvider->getBufferSize(E_RESPO, eSTEREO_SCENARIO_CAPTURE),     StereoArea(544, 288, 64, 16, 32, 8));
}
