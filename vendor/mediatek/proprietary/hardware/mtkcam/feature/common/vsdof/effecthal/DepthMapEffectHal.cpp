...
setParametersImpl(sp<EffectParameter> parameter)
{
    ...
    // TODO: query from custom
    mFlowType = eDEPTH_FLOW_TYPE_QUEUED_DEPTH;
    return OK;
}
...
{
    Mutex::Autolock autoLock(mOpLock);
    mpDepthMapPipe = IDepthMapPipe::createInstance(mFlowType, miSensorIdx_Main1, miSensorIdx_Main2);
