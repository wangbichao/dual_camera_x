...
LOCAL_SRC_FILES += $(CFB_DIR)/CFBcontrol.cpp
LOCAL_SRC_FILES += $(CFB_DIR)/CFB.cpp
LOCAL_SRC_FILES += $(CFB_DIR)/FaceBeautyEffectHal.cpp
LOCAL_SRC_FILES += $(CFB_DIR)/FaceBeautySDKHal.cpp
...
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/hardware/mtkcam/middleware/v1/adapter/inc/Scenario
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/hardware/mtkcam/middleware/v1/adapter/Scenario/Shot/inc
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/hardware/mtkcam/middleware/v1/adapter/inc/Scenario/Shot/inc
