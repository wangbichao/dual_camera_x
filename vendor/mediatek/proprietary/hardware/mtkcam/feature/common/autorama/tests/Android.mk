...
LOCAL_SRC_FILES += dummycase.cpp
endif


LOCAL_C_INCLUDES:= \
    $(TOP)/$(MTKCAM_ALGO_INCLUDE)/libautopano \
    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/feature/include/common/autorama \
...
LOCAL_MODULE := autorama_ut
$(info Panorama support chip = $(SUPPORTED_PLATFORM))
