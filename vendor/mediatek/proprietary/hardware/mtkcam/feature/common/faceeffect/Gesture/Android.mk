...
LOCAL_SRC_FILES += \
    $(GS_DIR)/gs_hal_base.cpp \
    $(GS_DIR)/gs_hal.cpp \

LOCAL_C_INCLUDES:= \
     $(MTK_PATH_MTKCAM)/include/algorithm/$(PLATFORM)/libgd/ \
...
LOCAL_CFLAGS += -DGESTURE_DETECT_SUPPORT=1
else
LOCAL_CFLAGS += -DGESTURE_DETECT_SUPPORT=0
endif
...
LOCAL_MODULE := libfeature.gesture
