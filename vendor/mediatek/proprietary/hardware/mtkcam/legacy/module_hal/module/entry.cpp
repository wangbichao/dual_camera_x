...
extern "C"
status_t
MtkCam_getExternalDeviceListener(/*out*/sp<android::IBinder>& listener)
{
    MY_LOGD("MtkCam_getExternalDeviceListener");
#ifdef MTK_CROSSMOUNT_SUPPORT
    return NSCam::getCamDeviceManager()->getExternalDeviceListener(listener);
#else
    return NULL;
#endif
}
...
get_mtk_camera_module_methods()
{
    ...
    _methods =
    {
        ...
        //
        getExternalDeviceListener : MtkCam_getExternalDeviceListener,
    };
    return  &_methods;
}
