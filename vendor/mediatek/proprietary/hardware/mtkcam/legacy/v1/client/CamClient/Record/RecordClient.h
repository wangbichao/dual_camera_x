...
//
#include "../MyUtils.h"
#include <v1/ExtImgProc/IExtImgProc.h>
#include <v1/ExtImgProc/ExtImgProc.h>
using namespace android;
using namespace MtkCamUtils;
using namespace NSCam::Utils;
#include <v1/IParamsManager.h>
#include <v1/client/IRecordClient.h>
...
public:     ////
    ...
    //
protected:
    virtual uint32_t                getImgStrideUnit(size_t index) {return 16;}
...
protected:  ////
    ...
    volatile int32_t                mIsWaitBufBack;
    //
