    ...
    //
                                        ...
                                        , mi4BufCohe(i4BufCohe)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                if(FmtUtils::queryImgWidthStride(ms8ImgFormat, mu4ImgWidth, 0) == FmtUtils::queryImgWidthStride(ms8ImgFormat, mu4ImgWidth, 1)) //ISP 2.0 is byte align => ref: CamFormat
                                                {
                                                    mu4ImgWidthStrides[0] = ALIGN(FmtUtils::queryImgWidthStride(ms8ImgFormat, mu4ImgWidth, 0), mu4ImgStrides[0]);
                                                    mImgBufSize = ALIGN(mu4ImgWidth, mu4ImgStrides[0]) * mu4ImgHeight;
                                                    mu4ImgWidthStrides[1] = ALIGN(FmtUtils::queryImgWidthStride(ms8ImgFormat, mu4ImgWidth, 1), mu4ImgStrides[1]);
                                                ...
                                                else //ISP 3.0 is pixel align => ref: CamFormat
                                                {
                                                    mu4ImgWidthStrides[0] = ALIGN(FmtUtils::queryImgWidthStride(ms8ImgFormat, mu4ImgWidth, 0), mu4ImgStrides[0]);
                                                    mImgBufSize = ALIGN(mu4ImgWidth, mu4ImgStrides[0]) * mu4ImgHeight;
                                                    mu4ImgWidthStrides[1] = ALIGN(FmtUtils::queryImgWidthStride(ms8ImgFormat, mu4ImgWidth, 0), mu4ImgStrides[1])/2;
                                                    mImgBufSize += ALIGN(mu4ImgWidth, mu4ImgStrides[1]) * mu4ImgHeight /2;
                                                }
                                            }
                                            else if( ms8ImgFormat == MtkCameraParameters::PIXEL_FORMAT_YUV420P)
                                            {
                                                ...
                                                mu4ImgWidthStrides[1] = ALIGN(FmtUtils::queryImgWidthStride(ms8ImgFormat, mu4ImgWidth, 1), mu4ImgStrides[1]);
                                                mImgBufSize += ALIGN(mu4ImgWidth, mu4ImgStrides[1]) * mu4ImgHeight /2;
                                                mu4ImgWidthStrides[2] = ALIGN(FmtUtils::queryImgWidthStride(ms8ImgFormat, mu4ImgWidth, 2), mu4ImgStrides[2]);
