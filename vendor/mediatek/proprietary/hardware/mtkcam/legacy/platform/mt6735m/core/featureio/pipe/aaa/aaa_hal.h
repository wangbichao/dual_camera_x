...
public:
    ...
    */
    ...
    /**
    * @brief set current recording status
    */
    inline MVOID setIsRecording(MBOOL bIsRecording)
    {
        m_bIsRecording = bIsRecording;
    }
    /**
    * @brief get current recording status
    */
    inline MBOOL getIsRecording()
    {
