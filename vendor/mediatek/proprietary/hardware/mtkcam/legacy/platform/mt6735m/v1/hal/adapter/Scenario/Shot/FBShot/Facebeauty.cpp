...
#endif
#if 1
    { RES_MGR_DRV_SCEN_SW_CAM_PRV, 0, 0, 4, 1066000, 1 },
    { RES_MGR_DRV_SCEN_SW_CAM_CAP, 0, 0, 4, 1066000, 1 },
#endif
#else
...
lbExit:
    ...
    pImpShot->mEnlargeEyeLevel = 13;//LE;
    pImpShot->mSlimFaceLevel = 13;//LF;
    pImpShot->mWarpLevel = LW;
    pImpShot->mContrastLevel = 5;
    pImpShot->mExtremeBeauty = 0;//pInfo->iExtremeBeauty;
...
doCapture()
{
    ...
    if (requestBufs()
        ...
        &&  (!mCancel && createFBJpegImg(mpSource,mu4W_yuv,mu4H_yuv,
