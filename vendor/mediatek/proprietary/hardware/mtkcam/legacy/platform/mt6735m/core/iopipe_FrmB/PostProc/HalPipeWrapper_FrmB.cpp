...
NSCam::NSIoPipe::NSPostProc_FrmB::SwHwScenarioPathMapping mSwHwPathMapping_FrmB[eSoftwareScenario_total_num]=
{
	...
	//
    {eSoftwareScenario_Main2_Normal_Stream,  "Main2_NormalStream",  NSImageio_FrmB::NSIspio_FrmB::eDrvScenario_CC,  NSImageio_FrmB::NSIspio_FrmB::EPipePass_PASS2,  EPathCQ_CQ1},
    {eSoftwareScenario_Main2_Normal_Capture, "Main2_NormalCapture", NSImageio_FrmB::NSIspio_FrmB::eDrvScenario_CC,  NSImageio_FrmB::NSIspio_FrmB::EPipePass_PASS2,  EPathCQ_CQ1},
    {eSoftwareScenario_Main2_VSS_Capture,    "Main2_VSSCapture",    NSImageio_FrmB::NSIspio_FrmB::eDrvScenario_VSS, NSImageio_FrmB::NSIspio_FrmB::EPipePass_PASS2B, EPathCQ_CQ2},
    {eSoftwareScenario_Main2_ZSD_Capture,    "Main2_ZSDCapture",    NSImageio_FrmB::NSIspio_FrmB::eDrvScenario_CC,  NSImageio_FrmB::NSIspio_FrmB::EPipePass_PASS2,  EPathCQ_CQ1},
    {eSoftwareScenario_Main2_Pure_Raw_Stream,"Main2_IPRawStream",   NSImageio_FrmB::NSIspio_FrmB::eDrvScenario_IP,  NSImageio_FrmB::NSIspio_FrmB::EPipePass_PASS2,  EPathCQ_CQ1},
};
    ...
    EBufferTag bufferTag)
{
    ...
    else
    {
        ...
        NSImageio_FrmB::NSIspio_FrmB::PortInfo *ports = NULL;
        ports = new NSImageio_FrmB::NSIspio_FrmB::PortInfo[inPorts+outPorts];

        if (ports == NULL) {
            LOG_ERR("new ports failed!");
            return -1;
        }

        LOG_INF("ports new!, batch(%d),in/out(%d/%d)",bufPackageNum,inPorts,outPorts);
