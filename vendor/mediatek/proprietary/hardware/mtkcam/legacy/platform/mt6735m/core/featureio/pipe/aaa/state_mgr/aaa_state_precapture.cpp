...
sendIntent(intent2type<eIntent_CaptureStart>)
{
    ...
    IspTuningMgr::getInstance().sendIspTuningIOCtrl(m_pHal3A->getSensorDev(), IspTuningMgr::E_ISPTUNING_SET_GMA_SCENARIO, IspTuningMgr::E_GMA_SCENARIO_CAPTURE, 0);
