...
enum
{
#warning "[FIXME] SCHED_RR is not support now, should be removed"
    PRIO_RT_CAMERA_PREVIEW                  = 0,//avoid build error
    PRIO_RT_ISP_EVENT_THREAD                = 0,//avoid build error
    PRIO_RT_3A_THREAD                       = 0,//avoid build error
};
...
enum
{
    ...
    //
    //  3A-related
    NICE_CAMERA_3A_MAIN              = (ANDROID_PRIORITY_NORMAL - 8),
