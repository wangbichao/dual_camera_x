...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_MTKCAM_PLATFORM)/v1/hal/adapter/ResourceLock/

#-----------------------------------------------------------
LOCAL_SRC_FILES += BaseCamAdapter.Instance.cpp
LOCAL_SRC_FILES += BaseCamAdapter.cpp
LOCAL_SRC_FILES += ResourceLock/ResourceLock.cpp
#-----------------------------------------------------------
