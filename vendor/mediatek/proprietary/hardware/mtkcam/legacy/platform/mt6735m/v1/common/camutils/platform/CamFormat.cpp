 ...
 *   Camera Format -
 ******************************************************************************/
class CamFmt_YUV420SP_NV12 : public CamFmtBase
{
    typedef CamFmt_YUV420SP_NV12 classType;
public:     ////            Instantiation.
    static  classType*      inst() { static classType o; return &o; }
                            CamFmt_YUV420SP_NV12()
                                : CamFmtBase(
                                    "NV12 - 420sp 2 planar",
                                    MtkCameraParameters::PIXEL_FORMAT_YUV420SP_NV12,
                                    12,
                                    2
                                )
                            {
                            #if SUPPORT_IMAGEIO_FORMAT
                                meImageioFormat = eImgFmt_NV12;
                            #endif
                            }
