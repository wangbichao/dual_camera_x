...
LOCAL_SRC_FILES += MtkDefaultCamAdapter.3A.cpp
LOCAL_SRC_FILES += MtkDefaultCamAdapter.Capture.cpp
LOCAL_SRC_FILES += MtkDefaultCamAdapter.CaptureCallback.cpp
LOCAL_SRC_FILES += MtkDefaultCamAdapter.Record.cpp
LOCAL_SRC_FILES += MtkDefaultCamAdapter.Zoom.cpp
LOCAL_SRC_FILES += MtkDefaultCamAdapter.cpp
LOCAL_SRC_FILES += MtkDefaultCamParameter.cpp

LOCAL_SRC_FILES += Preview/MtkDefaultCamAdapter.Preview.cpp
