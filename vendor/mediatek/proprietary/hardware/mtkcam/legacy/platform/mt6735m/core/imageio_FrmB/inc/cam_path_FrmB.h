...
public:     //// constructors.
    ...
    )
    {
		...
		bypass_ispYuvPipe = 0;
		pix_id = 0;
		src_color_format = RAW8;
		::memset((void*)&en_Top,0,sizeof(en_Top));
		::memset((void*)&ctl_int,0,sizeof(ctl_int));
    }
    //
public:     //// operations.
...
public:
    ...
    CamPathPass1() :
        ...
        DupQIdx(0)
        {
			...
			::memset((void*)&m_isp_function_list,0,sizeof(m_isp_function_list));
        };
...
public:     //// constructors.
    ...
    {
        ::memset((void*)&lsc,0,sizeof(lsc));
        ::memset((void*)&nbc,0,sizeof(nbc));
        ::memset((void*)&seee,0,sizeof(seee));
        ::memset((void*)&esfko,0,sizeof(esfko));
        ::memset((void*)&aao,0,sizeof(aao));
        ::memset((void*)&lcso,0,sizeof(lcso));
        ::memset((void*)&prz,0,sizeof(prz));
        ::memset((void*)&flki,0,sizeof(flki));
        ::memset((void*)&cdrz,0,sizeof(cdrz));
        ::memset((void*)&ringTdriCfg,0,sizeof(ringTdriCfg));
        ::memset((void*)&capTdriCfg,0,sizeof(capTdriCfg));
        ::memset((void*)&bnr,0,sizeof(bnr));
        ::memset((void*)&cfa,0,sizeof(cfa));
        imgo_mux_en = _imgo_mux_en;
        imgo_mux = _imgo_mux;
        img2o_mux_en=_img2o_mux;
        img2o_mux=_img2o_mux;
        pTuningIspReg = 0;
        drvScenario = NSImageio_FrmB::NSIspio_FrmB::eDrvScenario_VSS;
    }
};
