...
#-----------------------------------------------------------
LOCAL_WHOLE_STATIC_LIBRARIES += libcam.iopipe.postproc_FrmB
LOCAL_WHOLE_STATIC_LIBRARIES += libcam.iopipe.camio_FrmB
...
#
LOCAL_SHARED_LIBRARIES += libimageio_plat_drv_FrmB
#
...
ifeq "'1'" "$(strip $(MTKCAM_USE_LEGACY_IMAGEIO))"
    LOCAL_SHARED_LIBRARIES += libimageio_FrmB
