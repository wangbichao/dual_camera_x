...
enum ESoftwareScenario
{
    ...
    eSoftwareScenario_Main2_Normal_Stream,
    eSoftwareScenario_Main2_Normal_Capture,
    eSoftwareScenario_Main2_VSS_Capture,
    eSoftwareScenario_Main2_ZSD_Capture,
    //eSoftwareScenario_Main2_Mfb_Capture,
    //eSoftwareScenario_Main2_Mfb_Blending,
    //eSoftwareScenario_Main2_Mfb_Mixing,
    //eSoftwareScenario_Main2_Vfb_Stream_1,
    //eSoftwareScenario_Main2_Vfb_Stream_2,
    eSoftwareScenario_Main2_Pure_Raw_Stream,
    //eSoftwareScenario_Main2_CC_Raw_Stream,
