...
/* No support two pixel mode */
   ...
   else if(currSensorDev & SENSOR_DEV_MAIN_2 ) {
        ...
        switch(meSensorDev) {
            ...
            case SENSOR_DEV_MAIN_2:
                ...
                if (sensorPara[2].inSrcTypeSel >= MIPI_SENSOR) {
                    ...
                    ret = pSeninfDrv->setSeninf4Scam(1,sensorPara[2].SCAM_CLK_INV,sensorPara[2].cropWidth,sensorPara[2].cropHeight,1,sensorPara[2].SCAM_DataNumber,sensorPara[2].SCAM_DDR_En);
