...
#-----------------------------------------------------------
LOCAL_SRC_FILES := NormalPipe.cpp
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_PLATFORM)/hardware/D2/include/mtkcam/drv

#
# metadata
LOCAL_C_INCLUDES += $(TOP)/$(MTKCAM_C_INCLUDES)/metadata
LOCAL_C_INCLUDES += $(TOP)/$(MTKCAM_C_INCLUDES)/metadata/client
#
