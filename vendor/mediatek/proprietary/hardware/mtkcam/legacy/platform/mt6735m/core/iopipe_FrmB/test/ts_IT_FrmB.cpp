...
#define __IMGO_ENABLE (0x2)
    ...
    //because ROME support only symetric cropping.
...
void _test_camio_::startThread(void)
{
    ...
    pthread_attr_t const attr = {0, NULL, 1024 * 1024, 4096, SCHED_RR,
        /*PRIO_RT_ISPDEQUEUE_THREAD*/90};/*LukeHu+-*/
