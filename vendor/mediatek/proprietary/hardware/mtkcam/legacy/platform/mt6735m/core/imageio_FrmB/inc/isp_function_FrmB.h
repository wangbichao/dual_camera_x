...
public:
    ...
    {
        ::memset((void*)&m_pP1CurCQDIspReg,0,sizeof(m_pP1CurCQDIspReg));
    };
...
public:
    ...
    ISP_TOP_CTRL():
        ...
        {
            ctl_mux_sel.reg_val=0;
			ctl_mux_sel2.reg_val=0;
			ctl_sram_mux_cfg.reg_val=0;
		    ctl_pix_id = 0;
...
public:
    ...
    MBOOL isMdpCropEn;
public:
    ISP_MDP_PIPE():mdp_imgxo_p2_en(0),CQ(CAM_ISP_CQ_NONE),magicNum(0),dupCqIdx(0),burstQueIdx(0),drvScenario(-1),isWaitBuf(MTRUE),enable2(0),dma_enable(0),isV3(MFALSE),isApplyTuning(MFALSE),isMdpCropEn(MFALSE){};
    ~ISP_MDP_PIPE(){};
...
struct stISP_BUF_INFO
{
    ...
    , next(_next)
    {
		...
		m_num_1 = 0;
		frm_cnt = 0;
		::memset((void*)&hrz_info,0,sizeof(hrz_info));
		header_info = 0;
		header_size = 0;
		mBufIdx = 0;
		img_stride = 0;
