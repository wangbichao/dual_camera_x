...
********************************************************************************/
ZSDScenario*
ZSDScenario::createInstance(EScenarioFmt rSensorType, MUINT32 const &dev, ERawPxlID const &bitorder)
{
...
*
********************************************************************************/
ZSDScenario::ZSDScenario(EScenarioFmt rSensorType, MUINT32 const &dev, ERawPxlID const &bitorder)
            : mIMemDrv(NULL)
            , mpCamIOPipe(NULL)
            , mpDpStream(NULL)
...
*******************************************************************************/
MBOOL ZSDScenario::
unmapPhyAddr( MUINT32 size, MINT32 id, MUINTPTR va, MINT32 secu, MINT32 cohe, MUINTPTR& pa )
{
    IMEM_BUF_INFO imembuf( size, id, va, pa, secu, cohe );
