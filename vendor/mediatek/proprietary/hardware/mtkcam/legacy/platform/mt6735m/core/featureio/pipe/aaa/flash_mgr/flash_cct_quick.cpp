...
#endif
        //@@ chnage interface (old: no current table, new: with current table)
        int ret;
        ret = mpFlashAlg->InterpolateCalData(calTestN, 0, 0, g_algCalData, nv->engTab.yTab, nv3A->rFlashAWBNVRAM.rCalibrationData.flashWBGain,
