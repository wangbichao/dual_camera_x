...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
protected:
                                    NormalStream(ENormalStreamTag streamTag,MUINT32 openedSensorIndex,NSCam::NSIoPipe::NSPostProc::EScenarioFormat scenFmt);
public:
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
    NSIoPipe::NSPostProc::HalPipeWrapper*         mpHalPipeWrapper;
    ...
    //vector<CropPathInfo>    mCropPaths; //CHRISTOPHER, do not need in current stage
    IHalSensorList*         mHalSensorList;
/*SensorStaticInfo        mSensorStaticInfo[1];*/
    MINT32                  mJpegWorkBufSize;
    //JPGCfg                  mJpegCfg;//CHRISTOPHER, do not need in current stage
    NSIoPipe::NSPostProc::EScenarioFormat mScenFmt;
};
