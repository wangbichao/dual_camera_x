...
typedef NSCam::NSIoPipe::NSPostProc::MCropRect MCropRect;
typedef NSCam::NSIoPipe::NSPostProc::QParams QParams;
...
protected:
    StreamBufferHandle(
            ...
            : mpStreamCtrl(pCtrl), mpFrame(pFrame), mStreamId(streamId), mpStreamBuffer(pStreamBuffer),
              muState(STATE_NOT_USED), muTransform(uTransform), muUsage(uUsage), mpImageBuffer(NULL) { }
