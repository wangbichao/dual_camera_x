...
init()
{
    miSensorNum = MAKE_HalSensorList()->queryNumberOfSensors();
    ...
    //
    {
        ...
        ::property_get("debug.camera.temperature.timer", cProperty, "0");
    ...
    {
        char cProperty[PROPERTY_VALUE_MAX];
        ::property_get("debug.camera.log.temperature", cProperty, "0");
...
init()
{
    ...
    mpIHalSensor = MAKE_HalSensorList()->createSensor(LOG_TAG, miOpenId);
