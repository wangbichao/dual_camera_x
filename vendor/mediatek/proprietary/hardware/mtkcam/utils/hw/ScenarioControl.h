...
#ifndef _MTK_HARDWARE_MTKCAM_UTILS_HW_SCENARIOCONTROL_H_
#define _MTK_HARDWARE_MTKCAM_UTILS_HW_SCENARIOCONTROL_H_
//
...
#endif  //_MTK_HARDWARE_MTKCAM_UTILS_HW_SCENARIOCONTROL_H_
