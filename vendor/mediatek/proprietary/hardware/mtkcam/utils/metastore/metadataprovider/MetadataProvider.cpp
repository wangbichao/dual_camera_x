    ...
    , mpHALMetadata()
{
    ...
    int32_t sensorType = pHalSensorList->queryType(i4OpenId);
    int32_t sensorDev = pHalSensorList->querySensorDevIdx(i4OpenId);
    const char* sensorDrvName = pHalSensorList->queryDriverName(i4OpenId);
    //
...
{
    IHalSensorList* pHalSensorList = MAKE_HalSensorList();
    int32_t sensorType = pHalSensorList->queryType(0);
    int32_t sensorDev = pHalSensorList->querySensorDevIdx(0);
    const char* sensorDrvName = pHalSensorList->queryDriverName(0);
    //
    mInfo = Info(i4OpenId, sensorDev, sensorType, sensorDrvName);
    //
    showCustInfo();
