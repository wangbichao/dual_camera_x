...
#ifndef _MTK_HARDWARE_MTKCAM_UTILS_IMGBUF_BASEIMAGEBUFFER_H_
#define _MTK_HARDWARE_MTKCAM_UTILS_IMGBUF_BASEIMAGEBUFFER_H_
//
...
#endif  //_MTK_HARDWARE_MTKCAM_UTILS_IMGBUF_BASEIMAGEBUFFER_H_
