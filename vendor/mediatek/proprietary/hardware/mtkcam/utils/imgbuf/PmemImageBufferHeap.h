...
#ifndef _MTK_HARDWARE_MTKCAM_UTILS_IMGBUF_PMEMIMAGEBUFFERHEAP_H_
#define _MTK_HARDWARE_MTKCAM_UTILS_IMGBUF_PMEMIMAGEBUFFERHEAP_H_
//
 ...
 ******************************************************************************/
class PmemImageBufferHeap : public NSImageBufferHeap::BaseImageBufferHeap
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Interface.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
public:     ////                    Creation.
    static  PmemImageBufferHeap*     create(
                                        char const* szCallerName,
                                        AllocImgParam_t const& rImgParam
                                    );

public:     ////                    Attributes.
    static  char const*             magicName() { return "PmemHeap"; }
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
protected:  ////
    virtual MBOOL                   doAllocPmem(MyHeapInfo& rHeapInfo, MyBufInfo& rBufInfo);
    virtual MVOID                   doDeallocPmem(MyHeapInfo& rHeapInfo, MyBufInfo& rBufInfo);
...
protected:  ////                    Destructor/Constructors.
     ...
     */
    virtual                         ~PmemImageBufferHeap() {}
                                    PmemImageBufferHeap(char const* szCallerName,AllocImgParam_t const& rImgParam);
...
private:
    MINT32                     mHeapUserFD;
    android::Vector<MINT32>    mHeapUserFDList;
    android::Vector<MUINT32>   mHeapUserVAList;
};
...
#endif  //_MTK_HARDWARE_MTKCAM_UTILS_IMGBUF_PMEMIMAGEBUFFERHEAP_H_
