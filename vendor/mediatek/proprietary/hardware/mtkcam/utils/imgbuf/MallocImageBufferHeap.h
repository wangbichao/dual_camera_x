...
#ifndef _MTK_HARDWARE_MTKCAM_UTILS_IMGBUF_MALLOCIMAGEBUFFERHEAP_H_
#define _MTK_HARDWARE_MTKCAM_UTILS_IMGBUF_MALLOCIMAGEBUFFERHEAP_H_
//
 ...
 ******************************************************************************/
class MallocImageBufferHeap : public NSImageBufferHeap::BaseImageBufferHeap
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Interface.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
public:     ////                    Creation.
    static  MallocImageBufferHeap*     create(
                                        char const* szCallerName,
                                        AllocImgParam_t const& rImgParam
                                    );

public:     ////                    Attributes.
    static  char const*             magicName() { return "MallocHeap"; }
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
protected:  ////
    virtual MBOOL                   doAllocMalloc(MyHeapInfo& rHeapInfo, MyBufInfo& rBufInfo);
    virtual MVOID                   doDeallocMalloc(MyHeapInfo& rHeapInfo, MyBufInfo& rBufInfo);
...
protected:  ////                    Destructor/Constructors.
     ...
     */
    virtual                         ~MallocImageBufferHeap() {}
                                    MallocImageBufferHeap(char const* szCallerName,AllocImgParam_t const& rImgParam);
...
#endif  //_MTK_HARDWARE_MTKCAM_UTILS_IMGBUF_MALLOCIMAGEBUFFERHEAP_H_
