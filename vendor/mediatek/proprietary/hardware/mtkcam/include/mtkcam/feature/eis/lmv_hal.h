...
public:
    ...
    /**
       ...
       */
    virtual MVOID GetGmv(MINT32 &aGMV_X, MINT32 &aGMV_Y, MUINT32 *confX=NULL, MUINT32 *confY=NULL) = 0;
   ...
   */
    ...
    virtual NSCam::MSize QueryMinSize(MBOOL isEISOn, NSCam::MSize sensorSize, NSCam::MSize outputSize, NSCam::MSize requestSize) = 0;
