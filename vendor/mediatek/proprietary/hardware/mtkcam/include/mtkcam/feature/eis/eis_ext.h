...
typedef enum
{
    ...
    EIS_MODE_EIS_22,//GIS
    EIS_MODE_EIS_25,
    EIS_MODE_EIS_25_STOP,
    EIS_MODE_EIS_25_GYRO_ONLY,
    EIS_MODE_EIS_25_IMAGE_ONLY,
} EIS_ADVMODE_ENUM;
...
typedef enum
{
    EIS_ALG_MODE_NONE = 0,
    EIS_ALG_MODE_EIS12,
    EIS_ALG_MODE_EIS25_FUSION,
    EIS_ALG_MODE_EIS25_GYRO_ONLY,
    EIS_ALG_MODE_EIS25_IMAGE_ONLY
} EIS_ALG_MODE;
...
#define EIS_MODE_ENABLE_EIS_25_GYRO_ONLY(x)       (x)|=(1<<EIS_MODE_EIS_25_GYRO_ONLY)
#define EIS_MODE_IS_EIS_25_GYRO_ONLY_ENABLED(x)   ((x& (1<<EIS_MODE_EIS_25_GYRO_ONLY))?true:false)

#define EIS_MODE_ENABLE_EIS_25_IMAGE_ONLY(x)      (x)|=(1<<EIS_MODE_EIS_25_IMAGE_ONLY)
#define EIS_MODE_IS_EIS_25_IMAGE_ONLY_ENABLED(x)  ((x& (1<<EIS_MODE_EIS_25_IMAGE_ONLY))?true:false)

#define EIS_MODE_ENABLE_EIS_25_STOP(x)      (x)|=(1<<EIS_MODE_EIS_25_STOP)
#define EIS_MODE_IS_EIS_25_STOP_ENABLED(x)  ((x& (1<<EIS_MODE_EIS_25_STOP))?true:false)

#define EIS_EANBLE_ADVANCED_EIS(x)    (EISCustom::isEnabledEIS25() ? EIS_MODE_ENABLE_EIS_25(x):EIS_MODE_ENABLE_EIS_22(x))
#define EIS_EANBLE_vHDR_EIS25(x)      (EISCustom::isEnabledEIS25_ImageMode() ? EIS_MODE_ENABLE_EIS_25(x):EIS_MODE_ENABLE_EIS_12(x))
