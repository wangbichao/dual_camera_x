...
enum EFeatureModule
{
    ...
    EFeatureModule_SRZ1      = 0x0002,
    EFeatureModule_FE           = 0x0004,  //fe module


    EFeatureModule_STA_FEO   = 0x0000,  //-----statistic dma data(linke feo), remove later
    EFeatureModule_STA_LCEI  = 0x0000,  //-----when use statistic dma data in lcei (only for work around), remove later
};
...
struct ModuleParamInfo
{
    ...
    MINT32 frameGroup;    //start from 0
    MVOID* moduleStruct;
public:     //// constructors.
...
public:     ////                    Instantiation.
     ...
     *
     */
    static  IFeatureStream*          createInstance(MUINT32 openedSensorIndex);
...
public:     ////                    Attributes.
     ...
     *
     */
    static  char const*             pipeName() { return "FeatureStream"; }
   ...
   virtual MBOOL          sendCommand(MINT32 cmd, MINTPTR arg1, MINTPTR arg2) = 0;//QQ
    /**
