...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_UTILS_METADATA_CLIENT_MTK_METADATA_TAG_H_
...
typedef enum mtk_camera_metadata_section_start {
    ...
    MTK_STEREO_FEATURE_START                     = (MTK_STEREO_FEATURE + MTK_VENDOR_TAG_SECTION)   << 16,
    MTK_HDR_FEATURE_START                       = (MTK_HDR_FEATURE + MTK_VENDOR_TAG_SECTION)   << 16,
...
typedef enum mtk_camera_metadata_tag {
    ...
    MTK_CONTROL_POST_RAW_SENSITIVITY_BOOST_RANGE,
    ...
    MTK_SENSOR_OPTICAL_BLACK_REGIONS,
    MTK_SENSOR_DYNAMIC_BLACK_LEVEL,
    MTK_SENSOR_DYNAMIC_WHITE_LEVEL,
    MTK_SENSOR_OPAQUE_RAW_SIZE,
    MTK_SENSOR_END,
    ...
    MTK_FACE_FEATURE_FORCE_FACE_3A,
    MTK_FACE_FEATURE_AVAILABLE_FORCE_FACE_3A,
    ...
    MTK_HDR_FEATURE_HDR_MODE            = MTK_HDR_FEATURE_START, // Control Meta
    MTK_HDR_FEATURE_VHDR_MODE,             // Dynamic Meta, for middleware & sensor
    MTK_HDR_FEATURE_AVAILABLE_HDR_MODES,  // Static Meta, for App query use, runtime decided in MetadataProvider
    MTK_HDR_FEATURE_AVAILABLE_VHDR_MODES,  // Static Meta, for middleware query use
    MTK_HDR_FEATURE_END,

    MTK_STEREO_FEATURE_DOF_LEVEL         = MTK_STEREO_FEATURE_START,
    MTK_STEREO_FEATURE_SUPPORTED_DOF_LEVEL,
    MTK_STEREO_FEATURE_RESULT_DOF_LEVEL,
    MTK_STEREO_FEATURE_WARNING,
    MTK_STEREO_FEATURE_DEPTH_AF_ON,
    MTK_STEREO_FEATURE_DISTANCE_MEASURE_ON,
    MTK_STEREO_FEATURE_RESULT_DISTANCE,
    MTK_STEREO_FEATURE_TOUCH_POSITION,
...
typedef enum mtk_camera_metadata_enum_android_control_scene_mode {
    ...
    MTK_CONTROL_SCENE_MODE_DEVICE_CUSTOM_START            = 100,
    MTK_CONTROL_SCENE_MODE_DEVICE_CUSTOM_END              = 127,
    // Camera1
...
typedef enum mtk_camera_metadata_enum_android_info_supported_hardware_level {
    ...
    MTK_INFO_SUPPORTED_HARDWARE_LEVEL_3,
...
typedef enum mtk_camera_metadata_num_hal_version {
    ...
    MTK_HAL_VERSION_3_4 = HARDWARE_DEVICE_API_VERSION(3, 4),
...
// MTK HDR
typedef enum mtk_camera_metadata_enum_hdr_mode { // Need align include/mtkcam/feature/hdrDetection/Defs.h
    MTK_HDR_FEATURE_HDR_MODE_OFF = 0,
    MTK_HDR_FEATURE_HDR_MODE_ON,
    MTK_HDR_FEATURE_HDR_MODE_AUTO,
    MTK_HDR_FEATURE_HDR_MODE_VIDEO_ON,
    MTK_HDR_FEATURE_HDR_MODE_VIDEO_AUTO,
} mtk_camera_metadata_enum_hdr_mode_t;

typedef enum mtk_camera_metadata_enum_vhdr_mode { // Need align include/mtkcam/drv/IHalSensor.h
    MTK_HDR_FEATURE_VHDR_MODE_OFF = 0,
    MTK_HDR_FEATURE_VHDR_MODE_IVHDR = 1,
    MTK_HDR_FEATURE_VHDR_MODE_MVHDR = 2,
    MTK_HDR_FEATURE_VHDR_MODE_ZVHDR = 9,
} mtk_camera_metadata_enum_vhdr_mode_t;
#endif
