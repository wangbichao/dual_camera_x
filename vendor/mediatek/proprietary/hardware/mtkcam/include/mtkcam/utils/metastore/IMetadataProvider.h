...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_UTILS_METASTORE_IMETADATAPROVIDER_H_
#define _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_UTILS_METASTORE_IMETADATAPROVIDER_H_
//
 ...
 ******************************************************************************/
class IMetadataProvider : public virtual android::RefBase
{
public:     ////                    Creation.
...
public:     //// hal 1 support
    ...
    virtual int                     setStaticData(IMetadata *pMeta) = 0;

    virtual int                     restoreStaticData() = 0;
};
...
#endif  //_MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_UTILS_METASTORE_IMETADATAPROVIDER_H_
