...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2DNGCap[] =
{
    ...
    // Raw 16
    {"Hal:Image:Raw16",              eSTREAMID_IMAGE_PIPE_RAW16,                        eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_RAW16, MSize(0, 0), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    // DepthMapNode - output
    // Hal
