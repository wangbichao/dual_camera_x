...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2Cap[] =
{
    ...
    // DepthMapNode - output
    {"Hal:Image:Disparity_Left",           eSTREAMID_IMAGE_PIPE_BMDEPTHMAPNODE_DISPARITY_L, eSTREAMTYPE_IMAGE_INOUT, 1, 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_Y16, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:Disparity_Right",          eSTREAMID_IMAGE_PIPE_BMDEPTHMAPNODE_DISPARITY_R, eSTREAMTYPE_IMAGE_INOUT, 1, 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_Y16, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    ...
    // BMPreProcessNode - output
    {"Hal:Image:MFBO1Final",               eSTREAMID_IMAGE_PIPE_BMDENOISE_MFBO_FINAL_0, eSTREAMTYPE_IMAGE_INOUT, 1, 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_BAYER12_UNPAK, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:MFBO2Final",               eSTREAMID_IMAGE_PIPE_BMDENOISE_MFBO_FINAL_1, eSTREAMTYPE_IMAGE_INOUT, 1, 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_BAYER12_UNPAK, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:MFBO1",                    eSTREAMID_IMAGE_PIPE_BMDENOISE_MFBO_0, eSTREAMTYPE_IMAGE_INOUT, 1, 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_BAYER12_UNPAK, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:MFBO2",                    eSTREAMID_IMAGE_PIPE_BMDENOISE_MFBO_1, eSTREAMTYPE_IMAGE_INOUT, 1, 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_BAYER12_UNPAK, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:W1",                       eSTREAMID_IMAGE_PIPE_BMDENOISE_W_0, eSTREAMTYPE_IMAGE_INOUT, 1, 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:W2",                       eSTREAMID_IMAGE_PIPE_BMDENOISE_W_1, eSTREAMTYPE_IMAGE_INOUT, 1, 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
