...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2PrvCap[] =
{
    ...
    {"Hal:Image:MainImage_Cap",     eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_MAINIMAGE_CAPYUV,eSTREAMTYPE_IMAGE_INOUT, 1, 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE,                              eImgFmt_YV12, MSize(3072, 1728), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:JPSMain1",          eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_JPSMAIN1YUV,     eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    {"Hal:Image:JPSMain2",          eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_JPSMAIN2YUV,     eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    // APP
    {"Hal:Image:DepthMap",          eSTREAMID_IMAGE_PIPE_DEPTHMAPNODE_DEPTHMAPYUV,     eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_WRITE_OFTEN | eBUFFER_USAGE_SW_READ_OFTEN | eBUFFER_USAGE_HW_CAMERA_READWRITE,                              eImgFmt_STA_BYTE, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    ...
    {"Hal:Image:LDCData",           eSTREAMID_IMAGE_PIPE_STEREO_DBG_LDC,               eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN,eImgFmt_STA_BYTE, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    // DualImageTransform
    {"Hal:Image:Dual_JPS",        	eSTREAMID_IMAGE_PIPE_DUALIMAGETRANSFORM_JPSYUV,    eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE,                              eImgFmt_YUY2, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    // Bokeh - output
    ...
    // JpegEnc_Bokeh
    {"Hal:Image:JpegEnc_Bokeh",     eSTREAMID_IMAGE_PIPE_JPG_Bokeh,                    eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN,eImgFmt_STA_BYTE, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    // JpegEnc_Clean
    {"Hal:Image:JpegEnc_Clean",     eSTREAMID_IMAGE_PIPE_JPG_CleanMainImg,             eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN,eImgFmt_STA_BYTE, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    // JpegEnc_JPS
    {"Hal:Image:JpegEnc_JPS",       eSTREAMID_IMAGE_PIPE_JPG_JPS,                      eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN,eImgFmt_STA_BYTE, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    //End
