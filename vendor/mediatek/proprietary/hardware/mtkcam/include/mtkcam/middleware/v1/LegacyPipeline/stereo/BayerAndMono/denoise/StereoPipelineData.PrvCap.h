...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2PrvCap[] =
{
    ...
    // DepthMapNode - output
    {"Hal:Image:Disparity_Left",           eSTREAMID_IMAGE_PIPE_BMDEPTHMAPNODE_DISPARITY_L, eSTREAMTYPE_IMAGE_INOUT, (size_t)get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_Y16, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:Disparity_Right",          eSTREAMID_IMAGE_PIPE_BMDEPTHMAPNODE_DISPARITY_R, eSTREAMTYPE_IMAGE_INOUT, (size_t)get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_Y16, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:WrappingMatrix",           eSTREAMID_IMAGE_PIPE_BMDENOISE_WAPING_MATRIX,    eSTREAMTYPE_IMAGE_INOUT, (size_t)get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_Y8, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:FD",                       eSTREAMID_IMAGE_YUV_FD,                          eSTREAMTYPE_IMAGE_OUT,   5, 5, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE,                               eImgFmt_YUY2, MSize(640, 360), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    // BMPreProcessNode - output
    {"Hal:Image:MFBO1Final",               eSTREAMID_IMAGE_PIPE_BMDENOISE_MFBO_FINAL_0, eSTREAMTYPE_IMAGE_INOUT, (size_t)get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_BAYER12_UNPAK, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:MFBO2Final",               eSTREAMID_IMAGE_PIPE_BMDENOISE_MFBO_FINAL_1, eSTREAMTYPE_IMAGE_INOUT, (size_t)get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_BAYER12_UNPAK, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:MFBO1",                    eSTREAMID_IMAGE_PIPE_BMDENOISE_MFBO_0, eSTREAMTYPE_IMAGE_INOUT, (size_t)get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_BAYER12_UNPAK, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:MFBO2",                    eSTREAMID_IMAGE_PIPE_BMDENOISE_MFBO_1, eSTREAMTYPE_IMAGE_INOUT, (size_t)get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_BAYER12_UNPAK, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:W1",                       eSTREAMID_IMAGE_PIPE_BMDENOISE_W_0, eSTREAMTYPE_IMAGE_INOUT, (size_t)get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:W2",                       eSTREAMID_IMAGE_PIPE_BMDENOISE_W_1, eSTREAMTYPE_IMAGE_INOUT, (size_t)get_stereo_bmdenoise_capture_buffer_cnt(), 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    // BMDeNoiseNode - output
    {"Hal:Image:DenoiseResult",            eSTREAMID_IMAGE_PIPE_YUV_JPEG,                 eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE,                              eImgFmt_STA_BYTE, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    {"Hal:Image:DenoiseThumb",             eSTREAMID_IMAGE_PIPE_YUV_THUMBNAIL,            eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN,eImgFmt_STA_BYTE, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    // JpegEnc
    {"Hal:Image:JpegEnc",                  eSTREAMID_IMAGE_JPEG,                          eSTREAMTYPE_IMAGE_INOUT, 0, 0, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN,eImgFmt_STA_BYTE, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_PROVIDER, NULL},
    //End
...
static const MINT32 gStereoP2ConnectSetting_P2PrvCap[] =
{
    ...
    eNODEID_StereoRootNode,   eNODEID_BMDepthMapNode,
    eNODEID_StereoRootNode,   eNODEID_BMPreProcessNode,
    eNODEID_BMPreProcessNode, eNODEID_BMDeNoiseNode,
    eNODEID_BMDepthMapNode,   eNODEID_BMDeNoiseNode,
