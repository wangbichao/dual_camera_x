...
static struct ImageStreamManager::image_stream_info_pool_setting gStereoImgStreamTbl_P2DNGCap[] =
{
    ...
    // DepthMapNode - output
    {"Hal:Image:Disparity_Left",           eSTREAMID_IMAGE_PIPE_BMDEPTHMAPNODE_DISPARITY_L, eSTREAMTYPE_IMAGE_INOUT, 1, 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
    {"Hal:Image:Disparity_Right",          eSTREAMID_IMAGE_PIPE_BMDEPTHMAPNODE_DISPARITY_R, eSTREAMTYPE_IMAGE_INOUT, 1, 1, eBUFFER_USAGE_SW_READ_OFTEN |eBUFFER_USAGE_HW_CAMERA_READWRITE| eBUFFER_USAGE_SW_WRITE_OFTEN, eImgFmt_YV12, MSize(1, 1), 0, 0, eStreamType_IMG_HAL_POOL, NULL},
