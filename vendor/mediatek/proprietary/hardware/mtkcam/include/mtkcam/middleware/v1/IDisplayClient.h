...
public:     ////                    Instantiation.
    ...
    static  IDisplayClient*         createInstance(int32_t const openId = 0);
...
public:     ////
    ...
    virtual void                    setFirstFrameBlack()            = 0;

    virtual void                    SetOrientationForDisplay(int32_t orientation) = 0;
