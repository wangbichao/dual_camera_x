...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_MAIN_HAL_IEXTERNALDEVICE_H_
#define _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_MAIN_HAL_IEXTERNALDEVICE_H_
//
...
#endif  //_MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_MAIN_HAL_IEXTERNALDEVICE_H_
