...
#ifndef _MTK_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_HDRNODE_H_
#define _MTK_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_HDRNODE_H_
...
public:
    ...
    struct  ConfigParams
    {
         ...
         */
        ImageStreamInfoSetT           vInFullRaw;

        /**
         * A pointer to a LCSO raw input image stream info.
         */
        ImageStreamInfoSetT           vInLcsoRaw;
         ...
         */
        android::sp<IImageStreamInfo> vOutYuvJpeg;

        /**
         * A pointer to a yuv thumbnail output image stream info.
         */
        android::sp<IImageStreamInfo> vOutYuvThumbnail;
...
#endif // _MTK_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_HDRNODE_H_
