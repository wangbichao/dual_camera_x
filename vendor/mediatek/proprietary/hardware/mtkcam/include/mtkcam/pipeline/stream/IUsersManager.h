...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_STREAM_IUSERSMANAGER_H_
#define _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_STREAM_IUSERSMANAGER_H_
//
...
#endif  //_MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_STREAM_IUSERSMANAGER_H_
