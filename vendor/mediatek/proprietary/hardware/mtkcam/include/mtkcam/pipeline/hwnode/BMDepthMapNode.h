...
#ifndef _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_BMDEPTHMAPNODE_
#define _MTK_PLATFORM_HARDWARE_INCLUDE_MTKCAM_V3_HWNODE_BMDEPTHMAPNODE_
//
#include <mtkcam/pipeline/pipeline/IPipelineNode.h>
#include <featurePipe/vsdof/IBMDepthMapPipe.h>
//
...
public:     ////                    Definitions.
    ...
    struct  InitParams
    {
         ...
         * Feature mode
         */
        MBOOL                       vsdof_mode = MTRUE;
        MBOOL                       denoise_mode = MFALSE;
        MBOOL                       stereoCapture_mode = MTRUE;
        /**
         * Sensor state
         */
        StereoSensorState           sensorState = eSENSOR_BAYER_BAYER;
    };
    ...
    struct  ConfigParams
    {
         ...
         */
        android::sp<IImageStreamInfo> pHalImageMY_S = NULL;
        /**
         * A pointer to DMW image stream info.
         */
        android::sp<IImageStreamInfo> pHalImageDMW = NULL;
...
public:     ////                    Operations.
    ...
    static android::sp<BMDepthMapNode>   createInstance();
