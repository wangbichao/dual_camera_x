...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_PIPELINE_PIPELINECONTEXT_H_
#define _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_PIPELINE_PIPELINECONTEXT_H_
//
...
public:
                                            NodeActor(
                                                ...
                                                , mpNode(pNode)
                                            {memset(&mInitParam,0,sizeof(InitParamsT));}
protected:
...
public:
    ...
    virtual MERROR                          setDataCallback(
...
public: //FIXME: workaround to get pool
    ...
    android::sp<PipelineContext>                queryOldContext() const { return mpOldContext; }
...
#endif  //_MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_PIPELINE_PIPELINE_PIPELINECONTEXT_H_
